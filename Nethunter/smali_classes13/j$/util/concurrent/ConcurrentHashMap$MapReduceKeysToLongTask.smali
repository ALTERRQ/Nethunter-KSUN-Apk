...
.method public final compute()V
    ...
    iget-object v0, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->transformer:Ljava/util/function/ToLongFunction;
    ...
    iget-object v0, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->reducer:Ljava/util/function/LongBinaryOperator;
    ...
    .line 5973
    iget-wide v14, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->basis:J

    .line 5974
    .local v14, "r":J
    iget v10, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->baseIndex:I

    .local v10, "i":I
    :goto_0
    iget v0, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->batch:I

    if-lez v0, :cond_1

    iget v0, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->baseLimit:I
    ...
    .line 5976
    invoke-virtual {v11, v1}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->addToPendingCount(I)V

    .line 5977
    new-instance v9, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;

    iget v0, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->batch:I

    ushr-int/lit8 v2, v0, 0x1

    iput v2, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->batch:I

    iput v8, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->baseLimit:I

    iget-object v5, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->tab:[Lj$/util/concurrent/ConcurrentHashMap$Node;

    iget-object v6, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;
    ...
    iput-object v12, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;

    .line 5979
    invoke-virtual {v12}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->fork()Ljava/util/concurrent/ForkJoinTask;
    ...
    .restart local v17    # "transformer":Ljava/util/function/ToLongFunction;, "Ljava/util/function/ToLongFunction<-TK;>;"
    :goto_1
    invoke-virtual/range {p0 .. p0}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->advance()Lj$/util/concurrent/ConcurrentHashMap$Node;
    ...
    iput-wide v14, v11, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->result:J

    .line 5985
    invoke-virtual/range {p0 .. p0}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceKeysToLongTask;->firstComplete()Ljava/util/concurrent/CountedCompleter;
