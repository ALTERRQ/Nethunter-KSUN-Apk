...
.method public final consumeRestoredStateForKey(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 56
    .local v2, "consumed":Landroid/os/Bundle;
    move-object v3, v0
    ...
    .line 56
    .local v6, "$i$a$-write-SavedStateRegistryImpl$consumeRestoredStateForKey$2":I
    invoke-static {v5, p1}, Landroidx/savedstate/SavedStateWriter;->remove-impl(Landroid/os/Bundle;Ljava/lang/String;)V

    .line 156
    .end local v5    # "$this$consumeRestoredStateForKey_u24lambda_u243":Landroid/os/Bundle;
    .end local v6    # "$i$a$-write-SavedStateRegistryImpl$consumeRestoredStateForKey$2":I
    nop
    ...
    .local v5, "$this$consumeRestoredStateForKey_u24lambda_u244":Landroid/os/Bundle;
    const/4 v6, 0x0

    .line 57
    .local v6, "$i$a$-read-SavedStateRegistryImpl$consumeRestoredStateForKey$3":I
    invoke-static {v5}, Landroidx/savedstate/SavedStateReader;->isEmpty-impl(Landroid/os/Bundle;)Z

    move-result v5

    .line 157
    .end local v5    # "$this$consumeRestoredStateForKey_u24lambda_u244":Landroid/os/Bundle;
    .end local v6    # "$i$a$-read-SavedStateRegistryImpl$consumeRestoredStateForKey$3":I
    nop
    ...
    .end local v2    # "consumed":Landroid/os/Bundle;
    :cond_3
    const/4 v0, 0x0
...
.method public final performRestore$savedstate_release(Landroid/os/Bundle;)V
    ...
    .local v4, "$this$performRestore_u24lambda_u2415":Landroid/os/Bundle;
    const/4 v5, 0x0

    .line 122
    .local v5, "$i$a$-read-SavedStateRegistryImpl$performRestore$3":I
    const-string v6, "androidx.lifecycle.BundlableSavedStateRegistry.key"

    invoke-static {v4, v6}, Landroidx/savedstate/SavedStateReader;->contains-impl(Landroid/os/Bundle;Ljava/lang/String;)Z
    ...
    .line 165
    .end local v4    # "$this$performRestore_u24lambda_u2415":Landroid/os/Bundle;
    .end local v5    # "$i$a$-read-SavedStateRegistryImpl$performRestore$3":I
    :cond_1
    nop
    ...
    .line 124
    iput-boolean v1, p0, Landroidx/savedstate/internal/SavedStateRegistryImpl;->isRestored:Z
...
.method public final performSave$savedstate_release(Landroid/os/Bundle;)V
    ...
    :try_start_0
    invoke-static/range {p0 .. p0}, Landroidx/savedstate/internal/SavedStateRegistryImpl;->access$getKeyToProviders$p(Landroidx/savedstate/internal/SavedStateRegistryImpl;)Ljava/util/Map;
    ...
    invoke-static {v10, v2, v1}, Landroidx/savedstate/SavedStateWriter;->putSavedState-impl(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .local v3, "$this$performSave_u24lambda_u2419":Landroid/os/Bundle;
    const/4 v4, 0x0

    .line 144
    .local v4, "$i$a$-read-SavedStateRegistryImpl$performSave$1":I
    invoke-static {v3}, Landroidx/savedstate/SavedStateReader;->isEmpty-impl(Landroid/os/Bundle;)Z

    move-result v5

    .line 189
    .end local v3    # "$this$performSave_u24lambda_u2419":Landroid/os/Bundle;
    .end local v4    # "$i$a$-read-SavedStateRegistryImpl$performSave$1":I
    ...
    .local v3, "$this$performSave_u24lambda_u2420":Landroid/os/Bundle;
    const/4 v4, 0x0

    .line 145
    .local v4, "$i$a$-write-SavedStateRegistryImpl$performSave$2":I
    const-string v5, "androidx.lifecycle.BundlableSavedStateRegistry.key"

    invoke-static {v3, v5, v0}, Landroidx/savedstate/SavedStateWriter;->putSavedState-impl(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/Bundle;)V

    .line 190
    .end local v3    # "$this$performSave_u24lambda_u2420":Landroid/os/Bundle;
    .end local v4    # "$i$a$-write-SavedStateRegistryImpl$performSave$2":I
    nop
    ...
    .local v3, "initialState$iv":Ljava/util/Map;
    .local v4, "$i$f$savedState":I
    .restart local v5    # "pairs$iv":[Lkotlin/Pair;
