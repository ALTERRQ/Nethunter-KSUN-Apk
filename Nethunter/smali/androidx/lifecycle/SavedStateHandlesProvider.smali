...
.method public final consumeRestoredStateForKey(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 196
    invoke-virtual/range {p0 .. p0}, Landroidx/lifecycle/SavedStateHandlesProvider;->performRestore()V
    ...
    .local v6, "$this$consumeRestoredStateForKey_u24lambda_u2410":Landroid/os/Bundle;
    const/4 v7, 0x0

    .line 201
    .local v7, "$i$a$-write-SavedStateHandlesProvider$consumeRestoredStateForKey$2":I
    invoke-static {v6, v1}, Landroidx/savedstate/SavedStateWriter;->remove-impl(Landroid/os/Bundle;Ljava/lang/String;)V

    .line 312
    .end local v6    # "$this$consumeRestoredStateForKey_u24lambda_u2410":Landroid/os/Bundle;
    .end local v7    # "$i$a$-write-SavedStateHandlesProvider$consumeRestoredStateForKey$2":I
    nop
    ...
    .local v6, "$this$consumeRestoredStateForKey_u24lambda_u2411":Landroid/os/Bundle;
    const/4 v7, 0x0

    .line 202
    .local v7, "$i$a$-read-SavedStateHandlesProvider$consumeRestoredStateForKey$3":I
    invoke-static {v6}, Landroidx/savedstate/SavedStateReader;->isEmpty-impl(Landroid/os/Bundle;)Z

    move-result v6

    .line 313
    .end local v6    # "$this$consumeRestoredStateForKey_u24lambda_u2411":Landroid/os/Bundle;
    .end local v7    # "$i$a$-read-SavedStateHandlesProvider$consumeRestoredStateForKey$3":I
    nop
...
.method public saveState()Landroid/os/Bundle;
    ...
    :cond_2
    invoke-direct/range {p0 .. p0}, Landroidx/lifecycle/SavedStateHandlesProvider;->getViewModel()Landroidx/lifecycle/SavedStateHandlesVM;
