...
.method public static final withCreated(Landroidx/lifecycle/LifecycleOwner;Lkotlin/jvm/functions/Function0;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v7, "$this$withStateAtLeastUnchecked$iv":Landroidx/lifecycle/Lifecycle;
    sget-object v1, Landroidx/lifecycle/Lifecycle$State;->CREATED:Landroidx/lifecycle/Lifecycle$State;
    ...
    .end local v1    # "state$iv":Landroidx/lifecycle/Lifecycle$State;
    .local v8, "state$iv":Landroidx/lifecycle/Lifecycle$State;
    const/4 v9, 0x0
    ...
    .line 235
    .local v10, "lifecycleDispatcher$iv":Lkotlinx/coroutines/MainCoroutineDispatcher;
    invoke-interface {p2}, Lkotlin/coroutines/Continuation;->getContext()Lkotlin/coroutines/CoroutineContext;

    move-result-object v1

    invoke-virtual {v10, v1}, Lkotlinx/coroutines/MainCoroutineDispatcher;->isDispatchNeeded(Lkotlin/coroutines/CoroutineContext;)Z

    move-result v11

    .line 236
    .local v11, "dispatchNeeded$iv":Z
    if-nez v11, :cond_1
    ...
    new-instance v1, Landroidx/lifecycle/WithLifecycleStateKt$withStateAtLeastUnchecked$2;

    invoke-direct {v1, p1}, Landroidx/lifecycle/WithLifecycleStateKt$withStateAtLeastUnchecked$2;-><init>(Lkotlin/jvm/functions/Function0;)V
    ...
    .line 95
    .end local v7    # "$this$withStateAtLeastUnchecked$iv":Landroidx/lifecycle/Lifecycle;
    .end local v8    # "state$iv":Landroidx/lifecycle/Lifecycle$State;
    .end local v9    # "$i$f$withStateAtLeastUnchecked":I
    .end local v10    # "lifecycleDispatcher$iv":Lkotlinx/coroutines/MainCoroutineDispatcher;
    .end local v11    # "dispatchNeeded$iv":Z
    :goto_0
    return-object v1
.end method
