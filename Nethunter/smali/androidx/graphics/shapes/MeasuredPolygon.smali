...
.method public final cutAndShift(F)Landroidx/graphics/shapes/MeasuredPolygon;
    ...
    .line 169
    :cond_1
    iget-object v6, v0, Landroidx/graphics/shapes/MeasuredPolygon;->cubics:Ljava/util/List;
    ...
    iget-object v7, v0, Landroidx/graphics/shapes/MeasuredPolygon;->cubics:Ljava/util/List;
    ...
    .line 171
    .local v7, "target":Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    nop

    .line 181
    invoke-virtual {v7, v1}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->cutAtProgress(F)Lkotlin/Pair;
    ...
    .line 182
    .local v8, "b2":Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    ...
    new-array v10, v4, [Landroidx/graphics/shapes/Cubic;
    ...
    .line 190
    .local v3, "retCubics":Ljava/util/List;
    const/4 v10, 0x1
    ...
    invoke-static {v14, v2}, Landroidx/graphics/shapes/Utils;->positiveModulo(FF)F
    ...
    .local v5, "$this$cutAndShift_u24lambda_u2410":Ljava/util/List;
    const/4 v11, 0x0
    ...
    invoke-static {v15, v2}, Landroidx/graphics/shapes/Utils;->positiveModulo(FF)F

    move-result v15

    .line 224
    iget-object v2, v0, Landroidx/graphics/shapes/MeasuredPolygon;->features:Ljava/util/List;
    ...
    .line 222
    invoke-direct {v14, v15, v2}, Landroidx/graphics/shapes/ProgressableFeature;-><init>(FLandroidx/graphics/shapes/Feature;)V
    ...
    .line 219
    .end local v5    # "$this$cutAndShift_u24lambda_u2410":Ljava/util/List;
    ...
    iget-object v5, v0, Landroidx/graphics/shapes/MeasuredPolygon;->measurer:Landroidx/graphics/shapes/Measurer;

    move-object v11, v10

    check-cast v11, Landroidx/collection/FloatList;

    invoke-direct {v4, v5, v2, v3, v11}, Landroidx/graphics/shapes/MeasuredPolygon;-><init>(Landroidx/graphics/shapes/Measurer;Ljava/util/List;Ljava/util/List;Landroidx/collection/FloatList;)V

    return-object v4

    .line 354
    .end local v2    # "newFeatures":Ljava/util/List;
    .end local v3    # "retCubics":Ljava/util/List;
    .end local v6    # "targetIndex":I
    .end local v7    # "target":Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    .end local v8    # "b2":Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
