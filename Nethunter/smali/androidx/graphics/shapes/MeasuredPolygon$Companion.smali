...
.method public final measurePolygon$graphics_shapes_release(Landroidx/graphics/shapes/Measurer;Landroidx/graphics/shapes/RoundedPolygon;)Landroidx/graphics/shapes/MeasuredPolygon;
    ...
    .line 243
    .local v8, "cubics":Ljava/util/List;
    new-instance v0, Ljava/util/ArrayList;
    ...
    .line 247
    .local v9, "featureToCubic":Ljava/util/List;
    const/4 v0, 0x0

    .local v0, "featureIndex":I
    invoke-virtual/range {p2 .. p2}, Landroidx/graphics/shapes/RoundedPolygon;->getFeatures$graphics_shapes_release()Ljava/util/List;
    ...
    .line 249
    .local v3, "feature":Landroidx/graphics/shapes/Feature;
    const/4 v4, 0x0

    .local v4, "cubicIndex":I
    ...
    .line 250
    instance-of v10, v3, Landroidx/graphics/shapes/Feature$Corner;
    ...
    .line 247
    .end local v3    # "feature":Landroidx/graphics/shapes/Feature;
    .end local v4    # "cubicIndex":I
    :cond_1
    ...
    .local v5, "$this$runningFold$iv$iv":Ljava/lang/Iterable;
    const/4 v10, 0x0
    ...
    .line 261
    invoke-interface {v6, v2}, Landroidx/graphics/shapes/Measurer;->measureCubic(Landroidx/graphics/shapes/Cubic;)F
    ...
    .line 263
    .local v1, "$i$a$-require-MeasuredPolygon$Companion$measurePolygon$measures$1$1$1":I
    nop

    .line 262
    .end local v1    # "$i$a$-require-MeasuredPolygon$Companion$measurePolygon$measures$1$1$1":I
    ...
    .line 354
    .end local v5    # "$this$runningFold$iv$iv":Ljava/lang/Iterable;
    ...
    .line 267
    .local v10, "measures":Ljava/util/List;
    ...
    .line 271
    .local v12, "outlineProgress":Landroidx/collection/MutableFloatList;
    const/4 v0, 0x0
    ...
    invoke-virtual {v12, v2}, Landroidx/collection/MutableFloatList;->add(F)Z
    ...
    .local v1, "$this$measurePolygon_u24lambda_u244":Ljava/util/List;
    const/4 v2, 0x0

    .line 278
    .local v2, "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    const/4 v3, 0x0
    ...
    .line 282
    invoke-virtual {v12, v5}, Landroidx/collection/MutableFloatList;->get(I)F

    move-result v14

    add-int/lit8 v15, v5, 0x1

    invoke-virtual {v12, v15}, Landroidx/collection/MutableFloatList;->get(I)F
    ...
    .end local v2    # "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    .local v16, "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    int-to-float v2, v15
    ...
    .line 281
    invoke-direct {v13, v14, v2}, Landroidx/graphics/shapes/ProgressableFeature;-><init>(FLandroidx/graphics/shapes/Feature;)V
    ...
    .end local v16    # "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    .restart local v2    # "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    :cond_8
    move/from16 v16, v2
    ...
    .end local v2    # "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    .end local v3    # "i":I
    .restart local v16    # "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    nop

    .line 277
    .end local v1    # "$this$measurePolygon_u24lambda_u244":Ljava/util/List;
    .end local v16    # "$i$a$-buildList-MeasuredPolygon$Companion$measurePolygon$features$1":I
    ...
    .line 289
    .local v13, "features":Ljava/util/List;
    new-instance v14, Landroidx/graphics/shapes/MeasuredPolygon;
