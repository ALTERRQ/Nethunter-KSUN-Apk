...
.method private constructor <init>(JJJLandroidx/graphics/shapes/CornerRounding;)V
    ...
    .param p3, "p1"    # J
    .param p5, "p2"    # J
    .param p7, "rounding"    # Landroidx/graphics/shapes/CornerRounding;
    ...
    iget-wide v2, p0, Landroidx/graphics/shapes/RoundedCorner;->p1:J

    invoke-static {v0, v1, v2, v3}, Landroidx/graphics/shapes/PointKt;->minus-ybeJwSQ(JJ)J

    move-result-wide v0

    invoke-static {v0, v1}, Landroidx/graphics/shapes/PointKt;->getDirection-DnnuFBc(J)J

    move-result-wide v0

    iput-wide v0, p0, Landroidx/graphics/shapes/RoundedCorner;->d1:J
    ...
    iput-wide v0, p0, Landroidx/graphics/shapes/RoundedCorner;->d2:J
    ...
    invoke-virtual {v0}, Landroidx/graphics/shapes/CornerRounding;->getRadius()F
    ...
    invoke-virtual {v0}, Landroidx/graphics/shapes/CornerRounding;->getSmoothing()F
    ...
    .line 491
    iget-wide v2, p0, Landroidx/graphics/shapes/RoundedCorner;->d1:J

    iget-wide v4, p0, Landroidx/graphics/shapes/RoundedCorner;->d2:J

    invoke-static {v2, v3, v4, v5}, Landroidx/graphics/shapes/PointKt;->dotProduct-ybeJwSQ(JJ)F
    ...
    iget v2, p0, Landroidx/graphics/shapes/RoundedCorner;->cosAngle:F

    invoke-static {v2}, Landroidx/graphics/shapes/Utils;->square(F)F
    ...
    iput v2, p0, Landroidx/graphics/shapes/RoundedCorner;->sinAngle:F

    .line 501
    iget v2, p0, Landroidx/graphics/shapes/RoundedCorner;->sinAngle:F
    ...
    .line 502
    iget v2, p0, Landroidx/graphics/shapes/RoundedCorner;->cornerRadius:F

    iget v3, p0, Landroidx/graphics/shapes/RoundedCorner;->cosAngle:F
    ...
    .line 501
    :goto_2
    iput v2, p0, Landroidx/graphics/shapes/RoundedCorner;->expectedRoundCut:F
    ...
    iput-wide v0, p0, Landroidx/graphics/shapes/RoundedCorner;->center:J
...
.method private final calculateActualSmoothingValue(F)F
    ...
    iget v2, p0, Landroidx/graphics/shapes/RoundedCorner;->expectedRoundCut:F
...
.method private final computeFlankingCurve-oAJzIJU(FFJJJJJF)Landroidx/graphics/shapes/Cubic;
    .locals 34
    .param p1, "actualRoundCut"    # F
    .param p2, "actualSmoothingValues"    # F
    .param p3, "corner"    # J
    .param p5, "sideStart"    # J
    .param p7, "circleSegmentIntersection"    # J
    .param p9, "otherCircleSegmentIntersection"    # J
    .param p11, "circleCenter"    # J
    .param p13, "actualR"    # F
    ...
    invoke-static {v14, v15, v1, v2}, Landroidx/graphics/shapes/PointKt;->minus-ybeJwSQ(JJ)J
    ...
    .line 628
    .local v12, "sideDirection":J
    move/from16 v10, p1

    invoke-static {v12, v13, v10}, Landroidx/graphics/shapes/PointKt;->times-so9K2fw(JF)J
    ...
    invoke-static {v5, v6, v7}, Landroidx/graphics/shapes/PointKt;->times-so9K2fw(JF)J
    ...
    invoke-static {v5, v6, v11}, Landroidx/graphics/shapes/PointKt;->div-so9K2fw(JF)J
    ...
    invoke-static {v1, v2, v5, v6, v0}, Landroidx/graphics/shapes/PointKt;->interpolate-dLqxh1s(JJF)J
    ...
    invoke-static {v5, v6}, Landroidx/graphics/shapes/Utils;->directionVector(FF)J
    ...
    .line 643
    .local v5, "curveEnd":J
    invoke-static {v5, v6, v3, v4}, Landroidx/graphics/shapes/PointKt;->minus-ybeJwSQ(JJ)J

    move-result-wide v16

    invoke-static/range {v16 .. v17}, Landroidx/graphics/shapes/Utils;->rotate90-DnnuFBc(J)J

    move-result-wide v28

    .line 645
    .local v28, "circleTangent":J
    move-wide/from16 v30, v5

    .end local v5    # "curveEnd":J
    .local v30, "curveEnd":J
    ...
    .end local v8    # "curveStart":J
    .local v0, "curveStart":J
    move-wide v8, v12
    ...
    .end local v12    # "sideDirection":J
    .local v32, "sideDirection":J
    move-wide/from16 v12, v28

    invoke-direct/range {v5 .. v13}, Landroidx/graphics/shapes/RoundedCorner;->lineIntersection-CBFvKDc(JJJJ)Landroidx/collection/FloatFloatPair;

    move-result-object v5

    if-eqz v5, :cond_0

    invoke-virtual {v5}, Landroidx/collection/FloatFloatPair;->unbox-impl()J
    ...
    .line 649
    .local v5, "anchorEnd":J
    invoke-static {v5, v6, v2}, Landroidx/graphics/shapes/PointKt;->times-so9K2fw(JF)J

    move-result-wide v7

    invoke-static {v0, v1, v7, v8}, Landroidx/graphics/shapes/PointKt;->plus-ybeJwSQ(JJ)J

    move-result-wide v7

    const/high16 v2, 0x40400000    # 3.0f

    invoke-static {v7, v8, v2}, Landroidx/graphics/shapes/PointKt;->div-so9K2fw(JF)J

    move-result-wide v7

    .line 650
    .local v7, "anchorStart":J
    ...
    invoke-direct/range {v16 .. v25}, Landroidx/graphics/shapes/Cubic;-><init>(JJJJLkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final lineIntersection-CBFvKDc(JJJJ)Landroidx/collection/FloatFloatPair;
    ...
    invoke-static/range {p7 .. p8}, Landroidx/graphics/shapes/Utils;->rotate90-DnnuFBc(J)J

    move-result-wide v4

    .line 659
    .local v4, "rotatedD1":J
    invoke-static {v2, v3, v4, v5}, Landroidx/graphics/shapes/PointKt;->dotProduct-ybeJwSQ(JJ)F
    ...
    invoke-static {v10, v11, v0, v1}, Landroidx/graphics/shapes/PointKt;->minus-ybeJwSQ(JJ)J

    move-result-wide v12

    invoke-static {v12, v13, v4, v5}, Landroidx/graphics/shapes/PointKt;->dotProduct-ybeJwSQ(JJ)F
    ...
    .line 666
    .local v8, "k":F
    invoke-static {v2, v3, v8}, Landroidx/graphics/shapes/PointKt;->times-so9K2fw(JF)J
    ...
    invoke-static {v12, v13}, Landroidx/collection/FloatFloatPair;->box-impl(J)Landroidx/collection/FloatFloatPair;
...
.method public final getCubics(FF)Ljava/util/List;
    .locals 26
    .param p1, "allowedCut0"    # F
    .param p2, "allowedCut1"    # F
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(FF)",
            "Ljava/util/List<",
    ...
    .line 521
    .local v15, "allowedCut":F
    nop

    .line 522
    iget v0, v14, Landroidx/graphics/shapes/RoundedCorner;->expectedRoundCut:F
    ...
    .line 534
    .local v13, "actualRoundCut":F
    invoke-direct/range {p0 .. p1}, Landroidx/graphics/shapes/RoundedCorner;->calculateActualSmoothingValue(F)F

    move-result v16

    .line 535
    .local v16, "actualSmoothing0":F
    move/from16 v11, p2

    invoke-direct {v14, v11}, Landroidx/graphics/shapes/RoundedCorner;->calculateActualSmoothingValue(F)F

    move-result v17

    .line 537
    .local v17, "actualSmoothing1":F
    iget v0, v14, Landroidx/graphics/shapes/RoundedCorner;->cornerRadius:F
    ...
    .line 539
    .local v18, "actualR":F
    invoke-static/range {v18 .. v18}, Landroidx/graphics/shapes/Utils;->square(F)F
    ...
    .line 541
    .local v12, "centerDistance":F
    iget-wide v0, v14, Landroidx/graphics/shapes/RoundedCorner;->p1:J

    iget-wide v2, v14, Landroidx/graphics/shapes/RoundedCorner;->d1:J

    iget-wide v4, v14, Landroidx/graphics/shapes/RoundedCorner;->d2:J

    invoke-static {v2, v3, v4, v5}, Landroidx/graphics/shapes/PointKt;->plus-ybeJwSQ(JJ)J

    move-result-wide v2

    const/high16 v4, 0x40000000    # 2.0f

    invoke-static {v2, v3, v4}, Landroidx/graphics/shapes/PointKt;->div-so9K2fw(JF)J

    move-result-wide v2

    invoke-static {v2, v3}, Landroidx/graphics/shapes/PointKt;->getDirection-DnnuFBc(J)J

    move-result-wide v2

    invoke-static {v2, v3, v12}, Landroidx/graphics/shapes/PointKt;->times-so9K2fw(JF)J
    ...
    invoke-static {v2, v3, v13}, Landroidx/graphics/shapes/PointKt;->times-so9K2fw(JF)J
    ...
    .line 543
    .local v19, "circleIntersection0":J
    iget-wide v0, v14, Landroidx/graphics/shapes/RoundedCorner;->p1:J

    iget-wide v2, v14, Landroidx/graphics/shapes/RoundedCorner;->d2:J
    ...
    .line 545
    .local v21, "circleIntersection2":J
    nop
    ...
    .line 552
    iget-wide v9, v14, Landroidx/graphics/shapes/RoundedCorner;->center:J
    ...
    .end local v12    # "centerDistance":F
    .local v25, "centerDistance":F
    move-wide/from16 v11, v23

    move/from16 v23, v13

    .end local v13    # "actualRoundCut":F
    .local v23, "actualRoundCut":F
    move/from16 v13, v18
    ...
    .line 556
    .local v24, "flanking0":Landroidx/graphics/shapes/Cubic;
    nop
    ...
    .line 568
    .local v0, "flanking2":Landroidx/graphics/shapes/Cubic;
    const/4 v1, 0x3

    new-array v1, v1, [Landroidx/graphics/shapes/Cubic;
    ...
    .line 570
    iget-wide v4, v14, Landroidx/graphics/shapes/RoundedCorner;->center:J
    ...
    .line 571
    iget-wide v5, v14, Landroidx/graphics/shapes/RoundedCorner;->center:J
    ...
    .line 572
    invoke-virtual/range {v24 .. v24}, Landroidx/graphics/shapes/Cubic;->getAnchor1X()F

    move-result v6

    .line 573
    invoke-virtual/range {v24 .. v24}, Landroidx/graphics/shapes/Cubic;->getAnchor1Y()F
    ...
    .line 569
    invoke-virtual/range {v3 .. v9}, Landroidx/graphics/shapes/Cubic$Companion;->circularArc(FFFFFF)Landroidx/graphics/shapes/Cubic;
    ...
    .line 526
    .end local v0    # "flanking2":Landroidx/graphics/shapes/Cubic;
    .end local v16    # "actualSmoothing0":F
    .end local v17    # "actualSmoothing1":F
    .end local v18    # "actualR":F
    .end local v19    # "circleIntersection0":J
    .end local v21    # "circleIntersection2":J
    .end local v23    # "actualRoundCut":F
    .end local v24    # "flanking0":Landroidx/graphics/shapes/Cubic;
    .end local v25    # "centerDistance":F
    :cond_1
    :goto_0
    iget-wide v0, v14, Landroidx/graphics/shapes/RoundedCorner;->p1:J
    ...
    iget-wide v1, v14, Landroidx/graphics/shapes/RoundedCorner;->p1:J

    invoke-static {v1, v2}, Landroidx/graphics/shapes/PointKt;->getX-DnnuFBc(J)F

    move-result v1

    iget-wide v2, v14, Landroidx/graphics/shapes/RoundedCorner;->p1:J
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroidx/graphics/shapes/Cubic$Companion;->straightLine(FFFF)Landroidx/graphics/shapes/Cubic;
