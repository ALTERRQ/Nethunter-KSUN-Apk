...
.method public static final circle(Landroidx/graphics/shapes/RoundedPolygon$Companion;IFFF)Landroidx/graphics/shapes/RoundedPolygon;
    .locals 10
    .param p0, "$this$circle"    # Landroidx/graphics/shapes/RoundedPolygon$Companion;
    ...
    invoke-direct {v6, p2, v4, v2, v3}, Landroidx/graphics/shapes/CornerRounding;-><init>(FFILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-static/range {v2 .. v9}, Landroidx/graphics/shapes/RoundedPolygonKt;->RoundedPolygon$default(IFFFLandroidx/graphics/shapes/CornerRounding;Ljava/util/List;ILjava/lang/Object;)Landroidx/graphics/shapes/RoundedPolygon;
    ...
    .line 44
    .end local v0    # "theta":F
    .end local v1    # "polygonRadius":F
    :cond_0
...
.method public static final pill(Landroidx/graphics/shapes/RoundedPolygon$Companion;FFFFF)Landroidx/graphics/shapes/RoundedPolygon;
    .locals 15
    .param p0, "$this$pill"    # Landroidx/graphics/shapes/RoundedPolygon$Companion;
    .param p1, "width"    # F
    .param p2, "height"    # F
    ...
    invoke-direct {v1, v0, v10}, Landroidx/graphics/shapes/CornerRounding;-><init>(FF)V
    ...
    .line 192
    .end local v8    # "wHalf":F
    .end local v9    # "hHalf":F
    :cond_1
    move/from16 v10, p3
    ...
    .line 193
    .local v0, "$i$a$-require-ShapesKt$pill$1":I
...
.method public static final pillStar(Landroidx/graphics/shapes/RoundedPolygon$Companion;FFIFLandroidx/graphics/shapes/CornerRounding;Landroidx/graphics/shapes/CornerRounding;Ljava/util/List;FFFF)Landroidx/graphics/shapes/RoundedPolygon;
    .locals 16
    .param p0, "$this$pillStar"    # Landroidx/graphics/shapes/RoundedPolygon$Companion;
    .param p1, "width"    # F
    .param p2, "height"    # F
    .param p3, "numVerticesPerRadius"    # I
    .param p4, "innerRadiusRatio"    # F
    .param p5, "rounding"    # Landroidx/graphics/shapes/CornerRounding;
    .param p6, "innerRounding"    # Landroidx/graphics/shapes/CornerRounding;
    .param p7, "perVertexRounding"    # Ljava/util/List;
    .param p8, "vertexSpacing"    # F
    .param p9, "startLocation"    # F
    .param p10, "centerX"    # F
    .param p11, "centerY"    # F
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 293
    .local v2, "pvRounding":Ljava/util/List;
    if-nez v2, :cond_3
    ...
    .line 294
    .local v14, "$i$a$-flatMap-ShapesKt$pillStar$3":I
    const/4 v15, 0x2

    new-array v15, v15, [Landroidx/graphics/shapes/CornerRounding;

    aput-object v8, v15, v1

    aput-object p6, v15, v0
    ...
    .line 468
    .end local v13    # "it":I
    .end local v14    # "$i$a$-flatMap-ShapesKt$pillStar$3":I
    ...
    .end local v2    # "pvRounding":Ljava/util/List;
    .local v11, "pvRounding":Ljava/util/List;
    :goto_3
    nop
    ...
    invoke-static {v0, v8, v11, v1, v2}, Landroidx/graphics/shapes/RoundedPolygonKt;->RoundedPolygon([FLandroidx/graphics/shapes/CornerRounding;Ljava/util/List;FF)Landroidx/graphics/shapes/RoundedPolygon;
    ...
    .line 286
    .end local v11    # "pvRounding":Ljava/util/List;
    :cond_4
    move/from16 v10, p3
    ...
    .line 287
    .local v0, "$i$a$-require-ShapesKt$pillStar$2":I
    new-instance v3, Ljava/lang/IllegalArgumentException;

    const-string v4, "innerRadius must be between 0 and 1"
    ...
    .line 283
    .end local v0    # "$i$a$-require-ShapesKt$pillStar$2":I
    :cond_5
    move/from16 v10, p3
    ...
    .line 284
    .local v0, "$i$a$-require-ShapesKt$pillStar$1":I
    new-instance v3, Ljava/lang/IllegalArgumentException;

    const-string v4, "Pill shapes must have positive width and height"
...
.method private static final pillStarVerticesFromNumVerts(IFFFFFFF)[F
    .locals 45
    .param p0, "numVerticesPerRadius"    # I
    .param p1, "width"    # F
    .param p2, "height"    # F
    .param p3, "innerRadius"    # F
    .param p4, "vertexSpacing"    # F
    .param p5, "startLocation"    # F
    .param p6, "centerX"    # F
    .param p7, "centerY"    # F
    ...
    .line 350
    .local v10, "perimeter":F
    const/16 v12, 0xb

    new-array v12, v12, [F

    .line 351
    .local v12, "sections":[F
    const/4 v13, 0x0
    ...
    .line 373
    .local v13, "currSecIndex":I
    const/4 v15, 0x0

    .line 374
    .local v15, "secStart":F
    aget v16, v12, v14

    .line 378
    .local v16, "secEnd":F
    mul-float v17, p5, v10
    ...
    .line 382
    .local v18, "arrayIndex":I
    move/from16 v19, v13

    move-object/from16 v20, v14

    .end local v13    # "currSecIndex":I
    .end local v14    # "result":[F
    .local v19, "currSecIndex":I
    .local v20, "result":[F
    ...
    .end local v9    # "circlePerimeter":F
    .local v24, "circlePerimeter":F
    neg-float v9, v7

    move-wide/from16 v25, v13

    .end local v13    # "rectBL":J
    .local v25, "rectBL":J
    ...
    .end local v2    # "vSegLen":F
    .end local v3    # "tPerVertex":F
    .local v9, "vSegLen":F
    .local v27, "tPerVertex":F
    invoke-static {v8, v5}, Landroidx/collection/FloatFloatPair;->constructor-impl(FF)J
    ...
    .local v15, "i":I
    .local v16, "secStart":F
    .local v17, "secEnd":F
    .local v18, "t":F
    .local v28, "arrayIndex":I
    :goto_0
    if-ge v15, v5, :cond_4

    .line 391
    rem-float v29, v18, v10

    .line 392
    .local v29, "boundedT":F
    ...
    .end local v10    # "perimeter":F
    .local v30, "perimeter":F
    ...
    .line 400
    .end local v30    # "perimeter":F
    .restart local v10    # "perimeter":F
    :cond_1
    move/from16 v30, v10

    .end local v10    # "perimeter":F
    .restart local v30    # "perimeter":F
    sub-float v5, v29, v16

    .line 401
    .local v5, "tInSection":F
    sub-float v10, v17, v16

    div-float v10, v5, v10

    .line 408
    .local v10, "tProportion":F
    if-eqz v21, :cond_2
    ...
    .end local v2    # "rectTR":J
    .end local v5    # "tInSection":F
    .end local v12    # "sections":[F
    .end local v22    # "rectBR":J
    .local v0, "sections":[F
    .local v1, "currRadius":F
    .local v4, "rectBR":J
    .local v11, "rectBL":J
    .local v25, "hSegLen":F
    .local v26, "tInSection":F
    .local v32, "endcapRadius":F
    .local v39, "rectTR":J
    neg-float v2, v7
    ...
    .line 426
    .end local v0    # "sections":[F
    .end local v11    # "rectBL":J
    .end local v26    # "tInSection":F
    .end local v32    # "endcapRadius":F
    .local v1, "endcapRadius":F
    .restart local v2    # "rectTR":J
    .local v4, "hSegLen":F
    .restart local v5    # "tInSection":F
    .restart local v12    # "sections":[F
    .restart local v22    # "rectBR":J
    .local v25, "rectBL":J
    .local v39, "currRadius":F
    :pswitch_0
    nop
    ...
    .end local v1    # "endcapRadius":F
    .restart local v32    # "endcapRadius":F
    invoke-static/range {v33 .. v38}, Landroidx/graphics/shapes/Utils;->radialToCartesian-L6JJ3z0$default(FFJILjava/lang/Object;)J
    ...
    .line 423
    .end local v32    # "endcapRadius":F
    .restart local v1    # "endcapRadius":F
    :pswitch_1
    move/from16 v32, v1
    ...
    .line 421
    invoke-static {v2, v3, v13, v14}, Landroidx/graphics/shapes/PointKt;->plus-ybeJwSQ(JJ)J
    ...
    .end local v12    # "sections":[F
    .end local v25    # "rectBL":J
    .restart local v0    # "sections":[F
    .restart local v11    # "rectBL":J
    invoke-static {v2, v3, v11, v12}, Landroidx/graphics/shapes/PointKt;->plus-ybeJwSQ(JJ)J
    ...
    invoke-static {v2, v1}, Landroidx/collection/FloatFloatPair;->constructor-impl(FF)J
    ...
    .local v4, "rectBR":J
    .local v25, "hSegLen":F
    .restart local v26    # "tInSection":F
    ...
    .end local v22    # "arrayIndex":I
    .restart local v28    # "arrayIndex":I
    invoke-static {v2, v3}, Landroidx/graphics/shapes/PointKt;->getY-DnnuFBc(J)F

    move-result v23

    add-float v23, v23, p7
    ...
    .line 387
    .end local v1    # "currRadius":F
    .end local v2    # "vertex":J
    .end local v10    # "tProportion":F
    .end local v26    # "tInSection":F
    .end local v29    # "boundedT":F
...
.method public static final rectangle(Landroidx/graphics/shapes/RoundedPolygon$Companion;FFLandroidx/graphics/shapes/CornerRounding;Ljava/util/List;FF)Landroidx/graphics/shapes/RoundedPolygon;
    .locals 7
    .param p0, "$this$rectangle"    # Landroidx/graphics/shapes/RoundedPolygon$Companion;
    .param p1, "width"    # F
    .param p2, "height"    # F
    .param p3, "rounding"    # Landroidx/graphics/shapes/CornerRounding;
    .param p4, "perVertexRounding"    # Ljava/util/List;
    .param p5, "centerX"    # F
    .param p6, "centerY"    # F
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 95
    invoke-static {v5, p3, p4, p5, p6}, Landroidx/graphics/shapes/RoundedPolygonKt;->RoundedPolygon([FLandroidx/graphics/shapes/CornerRounding;Ljava/util/List;FF)Landroidx/graphics/shapes/RoundedPolygon;
...
.method public static final star(Landroidx/graphics/shapes/RoundedPolygon$Companion;IFFLandroidx/graphics/shapes/CornerRounding;Landroidx/graphics/shapes/CornerRounding;Ljava/util/List;FF)Landroidx/graphics/shapes/RoundedPolygon;
    .locals 20
    .param p0, "$this$star"    # Landroidx/graphics/shapes/RoundedPolygon$Companion;
    .param p1, "numVerticesPerRadius"    # I
    .param p2, "radius"    # F
    .param p3, "innerRadius"    # F
    .param p4, "rounding"    # Landroidx/graphics/shapes/CornerRounding;
    .param p5, "innerRounding"    # Landroidx/graphics/shapes/CornerRounding;
    .param p6, "perVertexRounding"    # Ljava/util/List;
    .param p7, "centerX"    # F
    .param p8, "centerY"    # F
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 154
    .local v6, "pvRounding":Ljava/util/List;
    if-nez v6, :cond_1
    ...
    .line 155
    .local v17, "$i$a$-flatMap-ShapesKt$star$1":I
    move-object/from16 v18, v6

    .end local v6    # "pvRounding":Ljava/util/List;
    .local v18, "pvRounding":Ljava/util/List;
    const/4 v6, 0x2

    new-array v6, v6, [Landroidx/graphics/shapes/CornerRounding;

    aput-object v3, v6, v8

    const/16 v19, 0x1

    aput-object p5, v6, v19
    ...
    .line 462
    .end local v16    # "it":I
    .end local v17    # "$i$a$-flatMap-ShapesKt$star$1":I
    check-cast v6, Ljava/lang/Iterable;

    .line 463
    .local v6, "list$iv$iv":Ljava/lang/Iterable;
    invoke-static {v11, v6}, Lkotlin/collections/CollectionsKt;->addAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z
    ...
    .end local v18    # "pvRounding":Ljava/util/List;
    .local v6, "pvRounding":Ljava/util/List;
    :cond_0
    move-object/from16 v18, v6
    ...
    .restart local v18    # "pvRounding":Ljava/util/List;
    move-object v6, v11
    ...
    .end local v18    # "pvRounding":Ljava/util/List;
    .restart local v6    # "pvRounding":Ljava/util/List;
    goto :goto_1
    ...
    .restart local v6    # "pvRounding":Ljava/util/List;
    :goto_1
    invoke-static {v0, v1, v2, v4, v5}, Landroidx/graphics/shapes/ShapesKt;->starVerticesFromNumVerts(IFFFF)[F
    ...
    .line 160
    invoke-static {v8, v3, v6, v4, v5}, Landroidx/graphics/shapes/RoundedPolygonKt;->RoundedPolygon([FLandroidx/graphics/shapes/CornerRounding;Ljava/util/List;FF)Landroidx/graphics/shapes/RoundedPolygon;
    ...
    const-string v8, "innerRadius must be less than radius"
    ...
    const-string v8, "Star radii must both be greater than 0"
