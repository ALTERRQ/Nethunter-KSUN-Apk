...
.method public static final RoundedPolygon([FLandroidx/graphics/shapes/CornerRounding;Ljava/util/List;FF)Landroidx/graphics/shapes/RoundedPolygon;
    ...
    .line 341
    new-instance v15, Landroidx/graphics/shapes/RoundedCorner;
    ...
    invoke-static {v10, v13}, Landroidx/collection/FloatFloatPair;->constructor-impl(FF)J
    ...
    invoke-static {v10, v4}, Landroidx/collection/FloatFloatPair;->constructor-impl(FF)J
    ...
    invoke-virtual {v4}, Landroidx/graphics/shapes/RoundedCorner;->getExpectedRoundCut()F
    ...
    invoke-virtual/range {v17 .. v17}, Landroidx/graphics/shapes/RoundedCorner;->getExpectedCut()F
    ...
    sub-float v3, v18, v23

    invoke-static {v1, v3}, Landroidx/graphics/shapes/Utils;->distance(FF)F
    ...
    .local v25, "$this$map$iv":Ljava/lang/Iterable;
    ...
    .line 372
    .end local v25    # "$this$map$iv":Ljava/lang/Iterable;
    .restart local v8    # "$this$map$iv":Ljava/lang/Iterable;
    :cond_5
    move-object/from16 v25, v8

    .end local v8    # "$this$map$iv":Ljava/lang/Iterable;
    .restart local v25    # "$this$map$iv":Ljava/lang/Iterable;
    ...
    .line 381
    .local v1, "cutAdjusts":Ljava/util/List;
    const/4 v3, 0x0
    ...
    .line 399
    .local v3, "tempFeatures":Ljava/util/List;
    const/4 v4, 0x0
    ...
    .end local v1    # "cutAdjusts":Ljava/util/List;
    .local v20, "cutAdjusts":Ljava/util/List;
    invoke-static {v10, v11, v14, v15}, Landroidx/graphics/shapes/PointKt;->minus-ybeJwSQ(JJ)J
    ...
    .local v23, "nextVtxIndex":I
    invoke-static {v12, v13, v10, v11}, Landroidx/graphics/shapes/PointKt;->minus-ybeJwSQ(JJ)J

    move-result-wide v8

    invoke-static {v0, v1, v8, v9}, Landroidx/graphics/shapes/PointKt;->clockwise-ybeJwSQ(JJ)Z
    ...
    .end local v14    # "prevVertex":J
    .local v8, "prevVertex":J
    move-wide v14, v10
    ...
    .line 414
    sget-object v12, Landroidx/graphics/shapes/Cubic;->Companion:Landroidx/graphics/shapes/Cubic$Companion;
    ...
    invoke-virtual {v15}, Landroidx/graphics/shapes/Cubic;->getAnchor0X()F
    ...
    .line 414
    invoke-virtual {v12, v13, v14, v15, v0}, Landroidx/graphics/shapes/Cubic$Companion;->straightLine(FFFF)Landroidx/graphics/shapes/Cubic;
    ...
    .end local v8    # "prevVertex":J
    .end local v10    # "currVertex":J
    .end local v17    # "convex":Z
    .end local v23    # "nextVtxIndex":I
    .end local v24    # "nextVertex":J
    ...
    .end local v20    # "cutAdjusts":Ljava/util/List;
    .restart local v1    # "cutAdjusts":Ljava/util/List;
    :cond_a
    move-object/from16 v20, v1
    ...
    .end local v1    # "cutAdjusts":Ljava/util/List;
    .end local v4    # "i":I
    .restart local v20    # "cutAdjusts":Ljava/util/List;
    const/4 v0, 0x1
    ...
    invoke-direct {v1, v3, v4, v0}, Landroidx/graphics/shapes/RoundedPolygon;-><init>(Ljava/util/List;FF)V
    ...
    .end local v3    # "tempFeatures":Ljava/util/List;
    .end local v4    # "cx":F
    .end local v6    # "n":I
