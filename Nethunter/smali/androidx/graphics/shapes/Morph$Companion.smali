...
.method public final match$graphics_shapes_release(Landroidx/graphics/shapes/RoundedPolygon;Landroidx/graphics/shapes/RoundedPolygon;)Ljava/util/List;
    ...
    invoke-virtual/range {p1 .. p1}, Landroidx/graphics/shapes/RoundedPolygon;->getCenterX()F

    move-result v4

    invoke-virtual/range {p1 .. p1}, Landroidx/graphics/shapes/RoundedPolygon;->getCenterY()F
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/graphics/shapes/RoundedPolygon;->getCenterX()F

    move-result v5

    invoke-virtual/range {p2 .. p2}, Landroidx/graphics/shapes/RoundedPolygon;->getCenterY()F
    ...
    invoke-virtual {v11, v1}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->cutAtProgress(F)Lkotlin/Pair;
    ...
    .end local v2    # "measuredPolygon1":Landroidx/graphics/shapes/MeasuredPolygon;
    .local v18, "measuredPolygon1":Landroidx/graphics/shapes/MeasuredPolygon;
    move-object v2, v8
    ...
    .line 296
    .local v2, "newb1":Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    ...
    .line 299
    invoke-virtual {v6, v1}, Landroidx/graphics/shapes/DoubleMapper;->map(F)F
    ...
    .line 302
    .end local v17    # "minb":F
    .end local v20    # "b2a":F
    .restart local v0    # "b2a":F
    .restart local v1    # "minb":F
    :cond_3
    move/from16 v20, v0
    ...
    .end local v0    # "b2a":F
    .end local v1    # "minb":F
    .restart local v17    # "minb":F
    .restart local v20    # "b2a":F
    move-object v0, v9
    ...
    .end local v3    # "measuredPolygon2":Landroidx/graphics/shapes/MeasuredPolygon;
    .local v16, "measuredPolygon2":Landroidx/graphics/shapes/MeasuredPolygon;
    ...
    .end local v4    # "features1":Ljava/util/List;
    .local v21, "features1":Ljava/util/List;
    invoke-virtual {v1}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->getCubic()Landroidx/graphics/shapes/Cubic;
    ...
    .end local v2    # "newb1":Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    .end local v13    # "b1a":F
    .end local v17    # "minb":F
    ...
    .line 273
    .end local v16    # "measuredPolygon2":Landroidx/graphics/shapes/MeasuredPolygon;
    .end local v18    # "measuredPolygon1":Landroidx/graphics/shapes/MeasuredPolygon;
    .end local v21    # "features1":Ljava/util/List;
    .local v2, "measuredPolygon1":Landroidx/graphics/shapes/MeasuredPolygon;
    .restart local v3    # "measuredPolygon2":Landroidx/graphics/shapes/MeasuredPolygon;
    .restart local v4    # "features1":Ljava/util/List;
    :cond_4
    move-object/from16 v18, v2
    ...
    .end local v3    # "measuredPolygon2":Landroidx/graphics/shapes/MeasuredPolygon;
    .end local v4    # "features1":Ljava/util/List;
    .restart local v16    # "measuredPolygon2":Landroidx/graphics/shapes/MeasuredPolygon;
    .restart local v18    # "measuredPolygon1":Landroidx/graphics/shapes/MeasuredPolygon;
    .restart local v21    # "features1":Ljava/util/List;
    if-nez v11, :cond_5
