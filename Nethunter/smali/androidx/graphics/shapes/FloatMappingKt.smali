...
.method public static final linearMap(Landroidx/collection/FloatList;Landroidx/collection/FloatList;F)F
    ...
    invoke-static {v4, v2}, Landroidx/graphics/shapes/Utils;->positiveModulo(FF)F

    move-result v4

    .line 47
    .local v4, "segmentSizeY":F
    move v5, v3
    ...
    invoke-static {v6, v2}, Landroidx/graphics/shapes/Utils;->positiveModulo(FF)F
    ...
    .line 103
    .end local v3    # "segmentSizeX":F
    .end local v4    # "segmentSizeY":F
    .end local v5    # "positionInSegment":F
    .local v0, "$this$first$iv":Ljava/lang/Iterable;
    .local v1, "$i$f$first":I
    :cond_3
...
.method public static final validateProgress(Landroidx/collection/FloatList;)V
    ...
    .local v4, "acc$iv":Ljava/lang/Object;
    move-object v4, v1

    .line 106
    move-object v5, v2

    .local v5, "this_$iv$iv":Landroidx/collection/FloatList;
    const/4 v6, 0x0
    ...
    .line 108
    iget-object v7, v5, Landroidx/collection/FloatList;->content:[F

    .line 109
    .local v7, "content$iv$iv":[F
    const/4 v9, 0x0

    .local v9, "i$iv$iv":I
    iget v10, v5, Landroidx/collection/FloatList;->_size:I
    ...
    .line 96
    invoke-virtual/range {p0 .. p0}, Landroidx/collection/FloatList;->getSize()I
    ...
    .line 96
    .local v7, "$i$a$-count-FloatMappingKt$validateProgress$wraps$1":I
    invoke-virtual {v8, v6}, Landroidx/collection/FloatList;->get(I)F

    move-result v9

    add-int/lit8 v10, v6, -0x1

    invoke-virtual {v8, v10}, Landroidx/collection/FloatList;->get(I)F
    ...
    .line 117
    .end local v6    # "it":I
    .end local v7    # "$i$a$-count-FloatMappingKt$validateProgress$wraps$1":I
    :goto_3
    if-eqz v6, :cond_4
    ...
    .line 97
    .local v10, "$i$a$-require-FloatMappingKt$validateProgress$3":I
    ...
    .end local v10    # "$i$a$-require-FloatMappingKt$validateProgress$3":I
    new-instance v1, Ljava/lang/IllegalArgumentException;
    ...
    .line 93
    .end local v9    # "wraps":I
    :cond_9
    const/4 v9, 0x0

    .line 94
    .local v9, "$i$a$-require-FloatMappingKt$validateProgress$2":I
    new-instance v0, Ljava/lang/StringBuilder;
    ...
    .line 93
    .end local v9    # "$i$a$-require-FloatMappingKt$validateProgress$2":I
    new-instance v1, Ljava/lang/IllegalArgumentException;
