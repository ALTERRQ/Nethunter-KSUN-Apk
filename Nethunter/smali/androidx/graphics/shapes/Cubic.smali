...
.method public final calculateBounds$graphics_shapes_release([FZ)V
    ...
    .line 153
    .local v4, "t":F
    cmpg-float v16, v18, v4

    if-gtz v16, :cond_3

    cmpg-float v16, v4, v17
    ...
    invoke-static/range {v19 .. v20}, Landroidx/graphics/shapes/PointKt;->getX-DnnuFBc(J)F
    ...
    .line 155
    .local v19, "$i$a$-let-Cubic$calculateBounds$1":I
    cmpg-float v20, v16, v2
    ...
    .line 154
    .end local v16    # "it":F
    .end local v19    # "$i$a$-let-Cubic$calculateBounds$1":I
    move/from16 v19, v7
    ...
    .line 172
    .local v6, "t2":F
    cmpg-float v13, v18, v6

    if-gtz v13, :cond_d

    cmpg-float v13, v6, v17
    ...
    invoke-static {v13, v14}, Landroidx/graphics/shapes/PointKt;->getX-DnnuFBc(J)F
    ...
    .line 174
    .local v14, "$i$a$-let-Cubic$calculateBounds$3":I
    cmpg-float v22, v13, v2
    ...
    .line 173
    .end local v13    # "it":F
    .end local v14    # "$i$a$-let-Cubic$calculateBounds$3":I
    goto :goto_4

    .line 162
    .end local v5    # "t1":F
    .end local v6    # "t2":F
    .end local v19    # "minY":F
    .end local v21    # "xb":F
    .local v7, "minY":F
    .local v13, "xb":F
    :cond_10
    ...
    .end local v7    # "minY":F
    .end local v13    # "xb":F
    .restart local v19    # "minY":F
    .restart local v21    # "xb":F
    :cond_11
    :goto_4
    invoke-virtual/range {p0 .. p0}, Landroidx/graphics/shapes/Cubic;->getAnchor0Y()F
    ...
    invoke-static {v13, v14}, Landroidx/graphics/shapes/PointKt;->getY-DnnuFBc(J)F
    ...
    .line 191
    .local v7, "$i$a$-let-Cubic$calculateBounds$4":I
    ...
    .line 190
    .end local v3    # "it":F
    .end local v7    # "$i$a$-let-Cubic$calculateBounds$4":I
    move v13, v5
    ...
    .line 201
    invoke-virtual {v0, v7}, Landroidx/graphics/shapes/Cubic;->pointOnCurve-OOQOV4g$graphics_shapes_release(F)J
    ...
    .line 202
    .local v13, "$i$a$-let-Cubic$calculateBounds$5":I
    ...
    .line 201
    .end local v11    # "it":F
    .end local v13    # "$i$a$-let-Cubic$calculateBounds$5":I
    goto :goto_9
    ...
    .line 210
    .local v6, "$i$a$-let-Cubic$calculateBounds$6":I
    ...
    .line 209
    .end local v5    # "it":F
    .end local v6    # "$i$a$-let-Cubic$calculateBounds$6":I
    move v7, v14
    ...
    .end local v5    # "yb":F
    .end local v6    # "yc":F
    .restart local v13    # "yb":F
    .restart local v22    # "yc":F
    :goto_b
    move/from16 v7, v19
