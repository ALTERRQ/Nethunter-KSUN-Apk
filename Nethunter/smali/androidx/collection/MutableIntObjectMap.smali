...
.method private final findAbsoluteInsertIndex(I)I
    ...
    .local v16, "metadata$iv":[J
    .local v17, "$i$f$group":I
    int-to-long v8, v11
    ...
    .end local v16    # "metadata$iv":[J
    .end local v17    # "$i$f$group":I
    nop
    ...
    .local v2, "metadata$iv":[J
    const/4 v10, 0x0

    .line 1239
    .local v10, "$i$f$isDeleted":I
    const/4 v11, 0x0
    ...
    .line 913
    .end local v2    # "metadata$iv":[J
    .end local v10    # "$i$f$isDeleted":I
    :goto_3
    if-nez v2, :cond_4
    ...
    iget-object v13, v2, Landroidx/collection/MutableIntObjectMap;->metadata:[J
    ...
    iget v3, v2, Landroidx/collection/MutableIntObjectMap;->_capacity:I
    ...
    .end local v19    # "hash1":I
    .end local v20    # "hash2":I
    .local v3, "hash1":I
    .local v4, "hash2":I
    ...
    .end local v3    # "hash1":I
    .end local v4    # "hash2":I
    .restart local v19    # "hash1":I
    .restart local v20    # "hash2":I
...
.method public final remove(I)Ljava/lang/Object;
    ...
    .line 1074
    .local v5, "hash2$iv":I
    iget v6, v2, Landroidx/collection/IntObjectMap;->_capacity:I
    ...
    .line 1080
    iget-object v9, v2, Landroidx/collection/IntObjectMap;->metadata:[J
    ...
    .local v17, "$i$f$findKeyIndex$collection":I
    .local v18, "hash$iv":I
    int-to-long v3, v12
    ...
    .end local v12    # "x$iv$iv":J
    .end local v19    # "$this$match$iv$iv":J
    nop
    ...
    .local v19, "$this$lowestBitSet$iv$iv$iv":J
    const/16 v16, 0x0
    ...
    .end local v19    # "$this$lowestBitSet$iv$iv$iv":J
    nop
    ...
    iget-object v12, v2, Landroidx/collection/IntObjectMap;->keys:[I
    ...
    .end local v17    # "$i$f$findKeyIndex$collection":I
    .end local v18    # "hash$iv":I
    :goto_3
    move v2, v11
    ...
    .line 784
    invoke-virtual {v0, v2}, Landroidx/collection/MutableIntObjectMap;->removeValueAt(I)Ljava/lang/Object;
    ...
    .line 1100
    .local v2, "this_$iv":Landroidx/collection/IntObjectMap;
    .restart local v3    # "g$iv":J
    .restart local v5    # "hash2$iv":I
    .restart local v6    # "probeMask$iv":I
    .restart local v7    # "probeOffset$iv":I
    .restart local v8    # "probeIndex$iv":I
    .restart local v9    # "m$iv":J
    .restart local v17    # "$i$f$findKeyIndex$collection":I
    .restart local v18    # "hash$iv":I
    :cond_4
