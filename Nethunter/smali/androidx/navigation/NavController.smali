...
.method private final handleDeepLink([I[Landroid/os/Bundle;Z)Z
    ...
    invoke-static {v6, v1, v9, v3, v9}, Landroidx/navigation/NavController;->findDestination$default(Landroidx/navigation/NavController;ILandroidx/navigation/NavDestination;ILjava/lang/Object;)Landroidx/navigation/NavDestination;
    ...
    .line 651
    new-instance v4, Landroidx/navigation/NavController$$ExternalSyntheticLambda5;

    invoke-direct {v4, v3, v6}, Landroidx/navigation/NavController$$ExternalSyntheticLambda5;-><init>(Landroidx/navigation/NavDestination;Landroidx/navigation/NavController;)V
    ...
    invoke-virtual {v4, v5, v1}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroidx/navigation/internal/NavContext;I)Ljava/lang/String;
    ...
    .local v0, "index":I
    :cond_2
    iput-boolean v10, v6, Landroidx/navigation/NavController;->deepLinkHandled:Z
    ...
    .line 690
    instance-of v11, v5, Landroidx/navigation/NavGraph;
    ...
    invoke-virtual {v0, v11}, Landroidx/navigation/NavGraph;->findNode(I)Landroidx/navigation/NavDestination;
    ...
    .line 704
    iget-object v12, v6, Landroidx/navigation/NavController;->impl:Landroidx/navigation/internal/NavControllerImpl;
    ...
    .line 700
    invoke-direct {v6, v5, v4, v11, v9}, Landroidx/navigation/NavController;->navigate(Landroidx/navigation/NavDestination;Landroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    iget-object v9, v6, Landroidx/navigation/NavController;->navContext:Landroidx/navigation/internal/NavContext;

    invoke-virtual {v2, v9, v3}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroidx/navigation/internal/NavContext;I)Ljava/lang/String;
    ...
    const-string v10, " cannot be found in graph "
...
.method private static final handleDeepLink$lambda$21(Landroidx/navigation/NavDestination;Landroidx/navigation/NavController;Landroidx/navigation/NavOptionsBuilder;)Lkotlin/Unit;
    ...
    invoke-virtual {p2, v1, v2}, Landroidx/navigation/NavOptionsBuilder;->popUpTo(ILkotlin/jvm/functions/Function1;)V
...
.method private final tryRelaunchUpToExplicitStack()Z
    ...
    iget-boolean v0, v7, Landroidx/navigation/NavController;->deepLinkHandled:Z
    ...
    .line 333
    .local v11, "deepLinkIds":Ljava/util/List;
    ...
    .line 336
    .local v12, "deepLinkArgs":Ljava/util/ArrayList;
    ...
    .line 342
    .end local v0    # "leafDestinationId":I
    .local v13, "leafDestinationId":I
    if-eqz v12, :cond_2
    ...
    .local v0, "$this$tryRelaunchUpToExplicitStack_u24lambda_u243":Landroidx/navigation/NavDestination;
    const/4 v1, 0x0

    .line 346
    .local v1, "$i$a$-with-NavController$tryRelaunchUpToExplicitStack$1":I
    ...
    invoke-virtual {v2, v3}, Landroidx/navigation/NavGraph$Companion;->findStartDestination(Landroidx/navigation/NavGraph;)Landroidx/navigation/NavDestination;
    ...
    .line 345
    .end local v0    # "$this$tryRelaunchUpToExplicitStack_u24lambda_u243":Landroidx/navigation/NavDestination;
    .end local v1    # "$i$a$-with-NavController$tryRelaunchUpToExplicitStack$1":I
    nop
    ...
    .line 359
    .local v0, "navDeepLinkBuilder":Landroidx/navigation/NavDeepLinkBuilder;
    nop
    ...
    .local v17, "pairs$iv":[Lkotlin/Pair;
    move-object v1, v9
    ...
    invoke-static {v15, v2, v1}, Landroidx/savedstate/SavedStateWriter;->putParcelable-impl(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/Parcelable;)V
    ...
    .line 361
    .local v2, "$i$a$-let-NavController$tryRelaunchUpToExplicitStack$arguments$1$1":I
    invoke-static {v15, v1}, Landroidx/savedstate/SavedStateWriter;->putAll-impl(Landroid/os/Bundle;Landroid/os/Bundle;)V

    .line 362
    .end local v1    # "it":Landroid/os/Bundle;
    .end local v2    # "$i$a$-let-NavController$tryRelaunchUpToExplicitStack$arguments$1$1":I
    :cond_8
    nop
    ...
    .end local v17    # "pairs$iv":[Lkotlin/Pair;
    ...
    .local v4, "index":I
    .local v14, "deepLinkId":I
    const/4 v15, 0x0

    .line 366
    .local v15, "$i$a$-forEachIndexed-NavController$tryRelaunchUpToExplicitStack$2":I
    if-eqz v12, :cond_a
    ...
    invoke-virtual {v0, v14, v1}, Landroidx/navigation/NavDeepLinkBuilder;->addDestination(ILandroid/os/Bundle;)Landroidx/navigation/NavDeepLinkBuilder;
    ...
    .end local v14    # "deepLinkId":I
    .end local v15    # "$i$a$-forEachIndexed-NavController$tryRelaunchUpToExplicitStack$2":I
    move v4, v8
    ...
    .end local v4    # "index$iv":I
    .restart local v17    # "arguments":Landroid/os/Bundle;
...
.method private final tryRelaunchUpToGeneratedStack()Z
    ...
    .local v16, "currentDestination":Landroidx/navigation/NavDestination;
    ...
    .local v18, "pairs$iv":[Lkotlin/Pair;
    invoke-virtual {v2, v1, v4, v4, v15}, Landroidx/navigation/NavGraph;->matchDeepLinkComprehensive(Landroidx/navigation/NavDeepLinkRequest;ZZLandroidx/navigation/NavDestination;)Landroidx/navigation/NavDestination$DeepLinkMatch;
    ...
    .line 403
    invoke-virtual {v4, v15}, Landroidx/navigation/NavDestination;->addInDefaultArgs(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 406
    .local v4, "destinationArgs":Landroid/os/Bundle;
    if-eqz v4, :cond_5
    ...
    .line 406
    .local v19, "$i$a$-let-NavController$tryRelaunchUpToGeneratedStack$args$1$1":I
    ...
    .end local v19    # "$i$a$-let-NavController$tryRelaunchUpToGeneratedStack$args$1$1":I
    goto :goto_4

    .line 389
    .end local v16    # "currentDestination":Landroidx/navigation/NavDestination;
    .end local v17    # "destId":I
    .end local v18    # "pairs$iv":[Lkotlin/Pair;
    .local v1, "currentDestination":Landroidx/navigation/NavDestination;
    .local v2, "destId":I
    .local v4, "pairs$iv":[Lkotlin/Pair;
    :cond_3
    ...
    .end local v2    # "destId":I
    .end local v4    # "pairs$iv":[Lkotlin/Pair;
    .restart local v16    # "currentDestination":Landroidx/navigation/NavDestination;
    .restart local v17    # "destId":I
    .restart local v18    # "pairs$iv":[Lkotlin/Pair;
    goto :goto_4
    ...
    .restart local v4    # "pairs$iv":[Lkotlin/Pair;
    :cond_4
    move-object/from16 v16, v1
    ...
    invoke-direct {v2, v0}, Landroidx/navigation/NavDeepLinkBuilder;-><init>(Landroidx/navigation/NavController;)V
    ...
    invoke-static {v2, v4, v6, v5, v6}, Landroidx/navigation/NavDeepLinkBuilder;->setDestination$default(Landroidx/navigation/NavDeepLinkBuilder;ILandroid/os/Bundle;ILjava/lang/Object;)Landroidx/navigation/NavDeepLinkBuilder;

    move-result-object v2

    .line 414
    invoke-virtual {v2, v1}, Landroidx/navigation/NavDeepLinkBuilder;->setArguments(Landroid/os/Bundle;)Landroidx/navigation/NavDeepLinkBuilder;

    move-result-object v2

    .line 415
    invoke-virtual {v2}, Landroidx/navigation/NavDeepLinkBuilder;->createTaskStackBuilder()Landroidx/core/app/TaskStackBuilder;
    ...
    .line 416
    .local v2, "parentIntents":Landroidx/core/app/TaskStackBuilder;
    invoke-virtual {v2}, Landroidx/core/app/TaskStackBuilder;->startActivities()V

    .line 417
    iget-object v4, v0, Landroidx/navigation/NavController;->activity:Landroid/app/Activity;
...
.method public handleDeepLink(Landroid/content/Intent;)Z
    ...
    .line 533
    invoke-static/range {p1 .. p1}, Landroidx/navigation/NavControllerKt;->NavDeepLinkRequest(Landroid/content/Intent;)Landroidx/navigation/NavDeepLinkRequest;
    ...
    .line 532
    invoke-virtual {v9, v10, v8, v8, v11}, Landroidx/navigation/NavGraph;->matchDeepLinkComprehensive(Landroidx/navigation/NavDeepLinkRequest;ZZLandroidx/navigation/NavDestination;)Landroidx/navigation/NavDestination$DeepLinkMatch;
    ...
    invoke-static {v11, v12, v8, v12}, Landroidx/navigation/NavDestination;->buildDeepLinkIds$default(Landroidx/navigation/NavDestination;Landroidx/navigation/NavDestination;ILjava/lang/Object;)[I
    ...
    .line 553
    sget-object v8, Landroidx/navigation/internal/Log;->Companion:Landroidx/navigation/internal/Log$Companion;
    ...
    .line 553
    invoke-virtual {v8, v5, v10}, Landroidx/navigation/internal/Log$Companion;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v8, v15}, Ljava/util/Collection;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    .line 1303
    .local v14, "$i$a$-apply-SavedStateKt__SavedState_androidKt$savedState$2$iv":I
    move-object v15, v8
    ...
    .end local v4    # "pairs$iv":[Lkotlin/Pair;
    .local v20, "pairs$iv":[Lkotlin/Pair;
    ...
    .end local v14    # "$i$a$-apply-SavedStateKt__SavedState_androidKt$savedState$2$iv":I
    .end local v20    # "pairs$iv":[Lkotlin/Pair;
    move-object v3, v6
    ...
    .line 587
    .local v8, "$i$a$-let-NavController$handleDeepLink$4":I
    invoke-virtual {v6}, Landroid/app/Activity;->finish()V

    .line 589
    const/4 v10, 0x0

    invoke-virtual {v6, v10, v10}, Landroid/app/Activity;->overridePendingTransition(II)V
    ...
    .end local v8    # "$i$a$-let-NavController$handleDeepLink$4":I
    nop
    ...
    :goto_c
    invoke-direct {v1, v0, v5, v6}, Landroidx/navigation/NavController;->handleDeepLink([I[Landroid/os/Bundle;Z)Z
...
.method public final handleDeepLink(Landroidx/navigation/NavDeepLinkRequest;)Z
    ...
    invoke-direct {v0, v7, v4, v2}, Landroidx/navigation/NavController;->handleDeepLink([I[Landroid/os/Bundle;Z)Z
...
.method public navigate(ILandroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    iget-object v1, v6, Landroidx/navigation/NavController;->impl:Landroidx/navigation/internal/NavControllerImpl;
    ...
    .local v20, "finalNavOptions":Landroidx/navigation/NavOptions;
    ...
    .end local v20    # "finalNavOptions":Landroidx/navigation/NavOptions;
    .local v0, "finalNavOptions":Landroidx/navigation/NavOptions;
    :cond_3
    move-object/from16 v20, v0
    ...
    .restart local v20    # "finalNavOptions":Landroidx/navigation/NavOptions;
    move-object v0, v14
    ...
    .line 1366
    .local v0, "pairs$iv":[Lkotlin/Pair;
    array-length v3, v0
    ...
    .line 1367
    .local v12, "$this$savedState_u24lambda_u241$iv":Landroid/os/Bundle;
    const/4 v13, 0x0
    ...
    .end local v0    # "pairs$iv":[Lkotlin/Pair;
    .local v16, "pairs$iv":[Lkotlin/Pair;
    ...
    invoke-static {v0, v4}, Landroidx/savedstate/SavedStateWriter;->putAll-impl(Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .end local v12    # "$this$savedState_u24lambda_u241$iv":Landroid/os/Bundle;
    .end local v13    # "$i$a$-apply-SavedStateKt__SavedState_androidKt$savedState$2$iv":I
    .end local v16    # "pairs$iv":[Lkotlin/Pair;
    move-object v2, v3
    ...
    .end local v20    # "finalNavOptions":Landroidx/navigation/NavOptions;
    .restart local v0    # "finalNavOptions":Landroidx/navigation/NavOptions;
    :cond_5
    move-object v11, v0
    ...
    .line 1378
    .end local v16    # "item$iv$iv$iv":Ljava/util/Map$Entry;
    .end local v18    # "$i$f$savedState":I
    ...
    .end local v13    # "$this$mapTo$iv$iv$iv":Ljava/util/Map;
    .end local v14    # "$i$f$mapTo":I
    .restart local v18    # "$i$f$savedState":I
    ...
    .local v3, "$this$navigate_u24lambda_u2423":Landroid/os/Bundle;
    const/4 v4, 0x0

    .line 867
    .local v4, "$i$a$-write-NavController$navigate$2":I
    invoke-static {v3, v8}, Landroidx/savedstate/SavedStateWriter;->putAll-impl(Landroid/os/Bundle;Landroid/os/Bundle;)V

    .line 1391
    .end local v3    # "$this$navigate_u24lambda_u2423":Landroid/os/Bundle;
    ...
    .local v14, "combinedArgs":Landroid/os/Bundle;
    :goto_7
    nop
    ...
    .line 884
    invoke-virtual {v6, v0, v1}, Landroidx/navigation/NavController;->popBackStack(IZ)Z
    ...
    invoke-static {v6, v12, v2, v1, v2}, Landroidx/navigation/NavController;->findDestination$default(Landroidx/navigation/NavController;ILandroidx/navigation/NavDestination;ILjava/lang/Object;)Landroidx/navigation/NavDestination;
    ...
    iget-object v3, v6, Landroidx/navigation/NavController;->navContext:Landroidx/navigation/internal/NavContext;

    invoke-virtual {v2, v3, v12}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroidx/navigation/internal/NavContext;I)Ljava/lang/String;
    ...
    .line 900
    .local v3, "$i$a$-require-NavController$navigate$4":I
    ...
    iget-object v13, v6, Landroidx/navigation/NavController;->navContext:Landroidx/navigation/internal/NavContext;

    invoke-virtual {v5, v13, v7}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroidx/navigation/internal/NavContext;I)Ljava/lang/String;
    ...
    .line 899
    .end local v3    # "$i$a$-require-NavController$navigate$4":I
    ...
    invoke-direct {v6, v1, v14, v11, v2}, Landroidx/navigation/NavController;->navigate(Landroidx/navigation/NavDestination;Landroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    .line 894
    .local v0, "$i$a$-require-NavController$navigate$3":I
    nop

    .line 893
    .end local v0    # "$i$a$-require-NavController$navigate$3":I
    ...
    .end local v14    # "combinedArgs":Landroid/os/Bundle;
    .local v0, "finalNavOptions":Landroidx/navigation/NavOptions;
    :cond_14
    move-object/from16 v2, p4
