...
.method private final parseInputParams(Ljava/util/List;Landroidx/navigation/NavDeepLink$ParamQuery;Landroid/os/Bundle;Ljava/util/Map;)Z
    ...
    .line 307
    .local v3, "tempSavedState":Landroid/os/Bundle;
    ...
    invoke-virtual {v12, v3, v9, v13}, Landroidx/navigation/CollectionNavType;->put(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 340
    invoke-direct {v1, v3, v5, v8, v2}, Landroidx/navigation/NavDeepLink;->parseArgument(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;Landroidx/navigation/NavArgument;)V
    ...
    .line 342
    :cond_a
    invoke-direct {v1, v3, v5, v8, v2}, Landroidx/navigation/NavDeepLink;->parseArgumentForRepeatedParam(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;Landroidx/navigation/NavArgument;)Z
    ...
    .local v4, "$this$parseInputParams_u24lambda_u2424":Landroid/os/Bundle;
    const/4 v5, 0x0

    .line 352
    .local v5, "$i$a$-write-NavDeepLink$parseInputParams$3":I
    invoke-static {v4, v3}, Landroidx/savedstate/SavedStateWriter;->putAll-impl(Landroid/os/Bundle;Landroid/os/Bundle;)V

    .line 932
    .end local v4    # "$this$parseInputParams_u24lambda_u2424":Landroid/os/Bundle;
    .end local v5    # "$i$a$-write-NavDeepLink$parseInputParams$3":I
    nop
...
.method private final parseQuery()Ljava/util/Map;
    ...
    .line 774
    .local v11, "inputLiteral":Ljava/lang/String;
    sget-object v12, Lkotlin/text/Regex;->Companion:Lkotlin/text/Regex$Companion;

    invoke-virtual {v12, v11}, Lkotlin/text/Regex$Companion;->escape(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 776
    .end local v11    # "inputLiteral":Ljava/lang/String;
    :cond_3
...
.method public final getMatchingArguments(Landroid/net/Uri;Ljava/util/Map;)Landroid/os/Bundle;
    ...
    .line 183
    invoke-direct/range {p0 .. p0}, Landroidx/navigation/NavDeepLink;->getPathPattern()Lkotlin/text/Regex;
