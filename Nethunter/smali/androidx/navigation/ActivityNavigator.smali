...
.method public navigate(Landroidx/navigation/ActivityNavigator$Destination;Landroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)Landroidx/navigation/NavDestination;
    ...
    .line 83
    invoke-virtual/range {p1 .. p1}, Landroidx/navigation/ActivityNavigator$Destination;->getIntent()Landroid/content/Intent;
    ...
    .line 89
    invoke-virtual/range {p1 .. p1}, Landroidx/navigation/ActivityNavigator$Destination;->getDataPattern()Ljava/lang/String;
    ...
    invoke-static {v14, v9}, Landroidx/savedstate/SavedStateReader;->contains-impl(Landroid/os/Bundle;Ljava/lang/String;)Z
    ...
    invoke-virtual {v11, v8, v5}, Ljava/util/regex/Matcher;->appendReplacement(Ljava/lang/StringBuffer;Ljava/lang/String;)Ljava/util/regex/Matcher;

    .line 103
    invoke-virtual/range {p1 .. p1}, Landroidx/navigation/ActivityNavigator$Destination;->getArguments()Ljava/util/Map;
    ...
    .line 105
    .local v5, "navType":Landroidx/navigation/NavType;
    :goto_3
    if-eqz v5, :cond_3

    invoke-virtual {v5, v2, v9}, Landroidx/navigation/NavType;->get(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v6

    invoke-virtual {v5, v6}, Landroidx/navigation/NavType;->serializeAsValue(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 507
    .end local v5    # "navType":Landroidx/navigation/NavType;
    ...
    .line 98
    .restart local v9    # "argName":Ljava/lang/String;
    ...
    .line 99
    .local v5, "$i$a$-require-ActivityNavigator$navigate$2$1":I
    ...
    .end local v5    # "$i$a$-require-ActivityNavigator$navigate$2$1":I
    ...
    :cond_b
    invoke-virtual/range {p1 .. p1}, Landroidx/navigation/ActivityNavigator$Destination;->getId()I
