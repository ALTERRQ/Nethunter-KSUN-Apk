...
.method public final matchRouteComprehensive$navigation_common_release(Ljava/lang/String;ZZLandroidx/navigation/NavDestination;)Landroidx/navigation/NavDestination$DeepLinkMatch;
    ...
    .local v22, "$i$f$mapNotNull":I
    invoke-virtual {v5, v1, v9, v8, v6}, Landroidx/navigation/NavGraph;->matchRouteComprehensive(Ljava/lang/String;ZZLandroidx/navigation/NavDestination;)Landroidx/navigation/NavDestination$DeepLinkMatch;
    ...
    .end local v22    # "$i$f$mapNotNull":I
    .restart local v8    # "$this$mapNotNull$iv":Ljava/lang/Iterable;
    .restart local v9    # "$i$f$mapNotNull":I
    :cond_1
    move-object/from16 v21, v8
    ...
    .restart local v22    # "$i$f$mapNotNull":I
    ...
    .line 74
    .local v5, "bestChildMatch":Landroidx/navigation/NavDestination$DeepLinkMatch;
    iget-object v6, v0, Landroidx/navigation/internal/NavGraphImpl;->graph:Landroidx/navigation/NavGraph;

    invoke-virtual {v6}, Landroidx/navigation/NavGraph;->getParent()Landroidx/navigation/NavGraph;

    move-result-object v6

    if-eqz v6, :cond_6

    .local v6, "it":Landroidx/navigation/NavGraph;
    const/4 v7, 0x0

    .line 75
    .local v7, "$i$a$-let-NavGraphImpl$matchRouteComprehensive$bestParentMatch$1":I
    if-eqz p3, :cond_5
    ...
    invoke-virtual {v6, v1, v2, v9, v8}, Landroidx/navigation/NavGraph;->matchRouteComprehensive(Ljava/lang/String;ZZLandroidx/navigation/NavDestination;)Landroidx/navigation/NavDestination$DeepLinkMatch;
    ...
    .line 74
    .end local v6    # "it":Landroidx/navigation/NavGraph;
    .end local v7    # "$i$a$-let-NavGraphImpl$matchRouteComprehensive$bestParentMatch$1":I
    :goto_3
    goto :goto_4
    ...
    check-cast v7, Landroidx/navigation/NavDestination$DeepLinkMatch;
