...
.method public final addInDefaultArgs$navigation_common_release(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .local v3, "$this$addInDefaultArgs_u24lambda_u248":Landroid/os/Bundle;
    const/4 v4, 0x0

    .line 198
    .local v4, "$i$a$-write-NavDestinationImpl$addInDefaultArgs$1":I
    invoke-static {v3, p1}, Landroidx/savedstate/SavedStateWriter;->putAll-impl(Landroid/os/Bundle;Landroid/os/Bundle;)V

    .line 237
    .end local v3    # "$this$addInDefaultArgs_u24lambda_u248":Landroid/os/Bundle;
    ...
    .line 204
    .local v1, "$i$a$-require-NavDestinationImpl$addInDefaultArgs$2":I
    ...
    .line 203
    .end local v1    # "$i$a$-require-NavDestinationImpl$addInDefaultArgs$2":I
    new-instance v1, Ljava/lang/IllegalArgumentException;
...
.method public final matchDeepLink$navigation_common_release(Landroidx/navigation/NavDeepLinkRequest;)Landroidx/navigation/NavDestination$DeepLinkMatch;
    ...
    const-string v2, "navDeepLinkRequest"

    invoke-static {v1, v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    .line 114
    iget-object v2, v0, Landroidx/navigation/internal/NavDestinationImpl;->deepLinks:Ljava/util/List;
    ...
    iget-object v4, v0, Landroidx/navigation/internal/NavDestinationImpl;->deepLinks:Ljava/util/List;
    ...
    .line 119
    .local v5, "deepLink":Landroidx/navigation/NavDeepLink;
    ...
    invoke-virtual {v5, v1}, Landroidx/navigation/NavDeepLink;->matches$navigation_common_release(Landroidx/navigation/NavDeepLinkRequest;)Z
    ...
    iget-object v7, v0, Landroidx/navigation/internal/NavDestinationImpl;->arguments:Ljava/util/Map;

    invoke-virtual {v5, v6, v7}, Landroidx/navigation/NavDeepLink;->getMatchingArguments(Landroid/net/Uri;Ljava/util/Map;)Landroid/os/Bundle;
    ...
    invoke-virtual {v5, v6}, Landroidx/navigation/NavDeepLink;->calculateMatchingPathSegments$navigation_common_release(Landroid/net/Uri;)I

    move-result v15

    .line 127
    .local v15, "matchingPathSegments":I
    ...
    invoke-virtual {v5}, Landroidx/navigation/NavDeepLink;->getAction()Ljava/lang/String;
    ...
    invoke-virtual {v5, v13}, Landroidx/navigation/NavDeepLink;->getMimeTypeMatchRating(Ljava/lang/String;)I
    ...
    .line 135
    :cond_5
    iget-object v8, v0, Landroidx/navigation/internal/NavDestinationImpl;->arguments:Ljava/util/Map;

    invoke-direct {v0, v5, v6, v8}, Landroidx/navigation/internal/NavDestinationImpl;->hasRequiredArguments(Landroidx/navigation/NavDeepLink;Landroid/net/Uri;Ljava/util/Map;)Z
    ...
    .line 138
    :cond_6
    new-instance v17, Landroidx/navigation/NavDestination$DeepLinkMatch;

    .line 139
    iget-object v9, v0, Landroidx/navigation/internal/NavDestinationImpl;->destination:Landroidx/navigation/NavDestination;

    .line 140
    nop

    .line 141
    invoke-virtual {v5}, Landroidx/navigation/NavDeepLink;->isExactDeepLink()Z
    ...
    .local v18, "mimeTypeMatchLevel":I
    move v12, v15
    ...
    .local v20, "requestAction":Ljava/lang/String;
    move/from16 v14, v18

    invoke-direct/range {v8 .. v14}, Landroidx/navigation/NavDestination$DeepLinkMatch;-><init>(Landroidx/navigation/NavDestination;Landroid/os/Bundle;ZIZI)V

    .line 137
    nop

    .line 146
    .local v8, "newMatch":Landroidx/navigation/NavDestination$DeepLinkMatch;
    if-eqz v2, :cond_7

    invoke-virtual {v8, v2}, Landroidx/navigation/NavDestination$DeepLinkMatch;->compareTo(Landroidx/navigation/NavDestination$DeepLinkMatch;)I
    ...
    .end local v5    # "deepLink":Landroidx/navigation/NavDeepLink;
    .end local v6    # "uri":Landroid/net/Uri;
    .end local v7    # "matchingArguments":Landroid/os/Bundle;
    .end local v8    # "newMatch":Landroidx/navigation/NavDestination$DeepLinkMatch;
    .end local v15    # "matchingPathSegments":I
    .end local v16    # "matchingAction":Z
    .end local v18    # "mimeTypeMatchLevel":I
    .end local v19    # "mimeType":Ljava/lang/String;
    .end local v20    # "requestAction":Ljava/lang/String;
    goto :goto_0
...
.method public final matchRoute$navigation_common_release(Ljava/lang/String;)Landroidx/navigation/NavDestination$DeepLinkMatch;
    ...
    .line 103
    .local v1, "matchingPathSegments":I
    ...
    .end local v1    # "matchingPathSegments":I
