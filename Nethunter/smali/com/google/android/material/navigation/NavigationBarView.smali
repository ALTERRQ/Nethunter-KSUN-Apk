...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/navigation/NavigationBarView;->isSubMenuSupported()Z

    move-result v5

    invoke-direct {v2, v9, v3, v4, v5}, Lcom/google/android/material/navigation/NavigationBarMenu;-><init>(Landroid/content/Context;Ljava/lang/Class;IZ)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/navigation/NavigationBarView;->getSuggestedMinimumHeight()I

    move-result v3

    invoke-virtual {v2, v3}, Lcom/google/android/material/navigation/NavigationBarMenuView;->setMinimumHeight(I)V

    .line 210
    iget-object v2, v0, Lcom/google/android/material/navigation/NavigationBarView;->menuView:Lcom/google/android/material/navigation/NavigationBarMenuView;

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/navigation/NavigationBarView;->getCollapsedMaxItemCount()I
    ...
    .line 242
    :cond_2
    sget v2, Lcom/google/android/material/R$styleable;->NavigationBarView_horizontalItemTextAppearanceInactive:I
    ...
    .line 243
    invoke-virtual {v0, v2}, Lcom/google/android/material/navigation/NavigationBarView;->setHorizontalItemTextAppearanceInactive(I)V

    .line 247
    :cond_3
    sget v2, Lcom/google/android/material/R$styleable;->NavigationBarView_horizontalItemTextAppearanceActive:I
    ...
    .line 248
    invoke-virtual {v0, v2}, Lcom/google/android/material/navigation/NavigationBarView;->setHorizontalItemTextAppearanceActive(I)V
    ...
    .line 310
    invoke-virtual {v1, v12, v4}, Landroidx/appcompat/widget/TintTypedArray;->getInteger(II)I
    ...
    invoke-virtual {v1, v12, v14}, Landroidx/appcompat/widget/TintTypedArray;->getInteger(II)I
    ...
    .line 322
    invoke-static {v9, v1, v14}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 333
    invoke-virtual {v1, v14, v3}, Landroidx/appcompat/widget/TintTypedArray;->getInteger(II)I
    ...
    .line 343
    invoke-virtual {v9, v14, v15}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;
    ...
    .line 347
    invoke-virtual {v15, v3, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    .line 349
    .local v3, "itemActiveIndicatorWidth":I
    invoke-virtual {v0, v3}, Lcom/google/android/material/navigation/NavigationBarView;->setItemActiveIndicatorWidth(I)V

    .line 351
    sget v13, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_android_height:I

    .line 352
    invoke-virtual {v15, v13, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I
    ...
    .line 357
    invoke-virtual {v15, v2, v4}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I
    ...
    .line 362
    .local v18, "itemActiveIndicatorExpandedWidth":I
    ...
    .line 365
    .local v4, "expandedWidthString":Ljava/lang/String;
    if-eqz v4, :cond_11
    ...
    .local v19, "background":Landroid/graphics/drawable/Drawable;
    ...
    .end local v6    # "backgroundColorStateList":Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v15, v6, v5}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I
    ...
    .end local v19    # "background":Landroid/graphics/drawable/Drawable;
    .restart local v5    # "background":Landroid/graphics/drawable/Drawable;
    .restart local v6    # "backgroundColorStateList":Landroid/content/res/ColorStateList;
    :cond_11
    move-object/from16 v19, v5
    ...
    .restart local v19    # "background":Landroid/graphics/drawable/Drawable;
    move/from16 v5, v18

    .line 377
    .end local v18    # "itemActiveIndicatorExpandedWidth":I
    .local v5, "itemActiveIndicatorExpandedWidth":I
    :goto_4
    invoke-virtual {v0, v5}, Lcom/google/android/material/navigation/NavigationBarView;->setItemActiveIndicatorExpandedWidth(I)V

    .line 379
    sget v6, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_expandedHeight:I

    .line 380
    invoke-virtual {v15, v6, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v6

    .line 383
    .local v6, "itemActiveIndicatorExpandedHeight":I
    invoke-virtual {v0, v6}, Lcom/google/android/material/navigation/NavigationBarView;->setItemActiveIndicatorExpandedHeight(I)V

    .line 385
    move/from16 v18, v3

    .end local v3    # "itemActiveIndicatorWidth":I
    .local v18, "itemActiveIndicatorWidth":I
    sget v3, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_expandedMarginHorizontal:I

    .line 386
    invoke-virtual {v15, v3, v2}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v3

    .line 389
    .local v3, "itemActiveIndicatorExpandedMarginHorizontal":I
    invoke-virtual {v0, v3}, Lcom/google/android/material/navigation/NavigationBarView;->setItemActiveIndicatorExpandedMarginHorizontal(I)V

    .line 391
    move/from16 v20, v2

    .end local v2    # "itemActiveIndicatorMarginHorizontal":I
    .local v20, "itemActiveIndicatorMarginHorizontal":I
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/navigation/NavigationBarView;->getResources()Landroid/content/res/Resources;
    ...
    .end local v3    # "itemActiveIndicatorExpandedMarginHorizontal":I
    .local v21, "itemActiveIndicatorExpandedMarginHorizontal":I
    ...
    .line 397
    .local v3, "activeIndicatorExpandedStartPadding":I
    move/from16 v22, v3

    .end local v3    # "activeIndicatorExpandedStartPadding":I
    .local v22, "activeIndicatorExpandedStartPadding":I
    sget v3, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_expandedActiveIndicatorPaddingEnd:I
    ...
    .line 402
    .local v3, "activeIndicatorExpandedEndPadding":I
    nop
    ...
    .local v23, "activeIndicatorExpandedDefaultStartEndPadding":I
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/navigation/NavigationBarView;->getLayoutDirection()I
    ...
    .end local v3    # "activeIndicatorExpandedEndPadding":I
    .local v24, "activeIndicatorExpandedEndPadding":I
    if-ne v2, v3, :cond_12
    ...
    :goto_5
    sget v3, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_expandedActiveIndicatorPaddingTop:I
    ...
    .end local v4    # "expandedWidthString":Ljava/lang/String;
    .local v25, "expandedWidthString":Ljava/lang/String;
    invoke-virtual {v15, v3, v4}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I
    ...
    .end local v5    # "itemActiveIndicatorExpandedWidth":I
    .local v26, "itemActiveIndicatorExpandedWidth":I
    if-ne v4, v5, :cond_13
    ...
    :goto_6
    sget v5, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_expandedActiveIndicatorPaddingBottom:I
    ...
    .end local v6    # "itemActiveIndicatorExpandedHeight":I
    .local p1, "itemActiveIndicatorExpandedHeight":I
    invoke-virtual {v15, v5, v6}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v5

    .line 402
    invoke-virtual {v0, v2, v3, v4, v5}, Lcom/google/android/material/navigation/NavigationBarView;->setItemActiveIndicatorExpandedPadding(IIII)V

    .line 414
    sget v2, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_android_color:I

    .line 415
    invoke-static {v9, v15, v2}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 421
    sget v3, Lcom/google/android/material/R$styleable;->NavigationBarActiveIndicator_shapeAppearance:I
    ...
    .line 424
    .local v3, "shapeAppearanceResId":I
    nop

    .line 425
    invoke-static {v9, v3, v4}, Lcom/google/android/material/shape/ShapeAppearanceModel;->builder(Landroid/content/Context;II)Lcom/google/android/material/shape/ShapeAppearanceModel$Builder;
    ...
    .line 338
    .end local v3    # "shapeAppearanceResId":I
    ...
    .end local v16    # "backgroundColorStateList":Landroid/content/res/ColorStateList;
    .end local v17    # "isBold":Z
    .end local v18    # "itemActiveIndicatorWidth":I
    .end local v19    # "background":Landroid/graphics/drawable/Drawable;
    .end local v20    # "itemActiveIndicatorMarginHorizontal":I
    .end local v21    # "itemActiveIndicatorExpandedMarginHorizontal":I
    .end local v22    # "activeIndicatorExpandedStartPadding":I
    .end local v23    # "activeIndicatorExpandedDefaultStartEndPadding":I
    .end local v24    # "activeIndicatorExpandedEndPadding":I
    .end local v25    # "expandedWidthString":Ljava/lang/String;
    .end local v26    # "itemActiveIndicatorExpandedWidth":I
    .end local p1    # "itemActiveIndicatorExpandedHeight":I
    .local v2, "isBold":Z
    .local v5, "background":Landroid/graphics/drawable/Drawable;
    .local v6, "backgroundColorStateList":Landroid/content/res/ColorStateList;
    :cond_14
    ...
    .line 437
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/navigation/NavigationBarView;->shouldAddMenuView()Z
