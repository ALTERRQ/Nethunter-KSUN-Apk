...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v2, Lcom/google/android/material/R$styleable;->MaterialButtonGroup_buttonSizeChange:I
    ...
    .line 155
    invoke-static {p1, v1, v2}, Lcom/google/android/material/shape/StateListSizeChange;->create(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lcom/google/android/material/shape/StateListSizeChange;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButtonGroup;->buttonSizeChange:Lcom/google/android/material/shape/StateListSizeChange;

    .line 159
    :cond_0
    sget v2, Lcom/google/android/material/R$styleable;->MaterialButtonGroup_shapeAppearance:I
    ...
    .line 161
    invoke-static {p1, v1, v2}, Lcom/google/android/material/shape/StateListShapeAppearanceModel;->create(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lcom/google/android/material/shape/StateListShapeAppearanceModel;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButtonGroup;->groupStateListShapeAppearance:Lcom/google/android/material/shape/StateListShapeAppearanceModel;

    .line 163
    iget-object v2, p0, Lcom/google/android/material/button/MaterialButtonGroup;->groupStateListShapeAppearance:Lcom/google/android/material/shape/StateListShapeAppearanceModel;

    if-nez v2, :cond_1

    .line 164
    new-instance v2, Lcom/google/android/material/shape/StateListShapeAppearanceModel$Builder;
    ...
    sget v4, Lcom/google/android/material/R$styleable;->MaterialButtonGroup_shapeAppearanceOverlay:I
    ...
    .line 166
    invoke-static {p1, v3, v4}, Lcom/google/android/material/shape/ShapeAppearanceModel;->builder(Landroid/content/Context;II)Lcom/google/android/material/shape/ShapeAppearanceModel$Builder;
    ...
    invoke-direct {v2, v3}, Lcom/google/android/material/shape/StateListShapeAppearanceModel$Builder;-><init>(Lcom/google/android/material/shape/ShapeAppearanceModel;)V

    .line 173
    invoke-virtual {v2}, Lcom/google/android/material/shape/StateListShapeAppearanceModel$Builder;->build()Lcom/google/android/material/shape/StateListShapeAppearanceModel;
    ...
    .line 176
    :cond_1
    sget v2, Lcom/google/android/material/R$styleable;->MaterialButtonGroup_innerCornerSize:I
    ...
    .line 178
    invoke-static {p1, v1, v2, v3}, Lcom/google/android/material/shape/StateListCornerSize;->create(Landroid/content/Context;Landroid/content/res/TypedArray;ILcom/google/android/material/shape/CornerSize;)Lcom/google/android/material/shape/StateListCornerSize;
    ...
    .line 185
    :cond_2
    sget v2, Lcom/google/android/material/R$styleable;->MaterialButtonGroup_android_spacing:I

    invoke-virtual {v1, v2, v7}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Lcom/google/android/material/button/MaterialButtonGroup;->spacing:I

    .line 187
    invoke-virtual {p0, v0}, Lcom/google/android/material/button/MaterialButtonGroup;->setChildrenDrawingOrderEnabled(Z)V

    .line 188
    sget v2, Lcom/google/android/material/R$styleable;->MaterialButtonGroup_android_enabled:I
...
.method updateChildShapes()V
    ...
    .line 281
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/button/MaterialButtonGroup;->getChildCount()I

    move-result v2

    .line 282
    .local v2, "childCount":I
    invoke-direct/range {p0 .. p0}, Lcom/google/android/material/button/MaterialButtonGroup;->getFirstVisibleChildIndex()I

    move-result v3

    .line 283
    .local v3, "firstVisibleChildIndex":I
    invoke-direct/range {p0 .. p0}, Lcom/google/android/material/button/MaterialButtonGroup;->getLastVisibleChildIndex()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/button/MaterialButtonGroup;->getOrientation()I
