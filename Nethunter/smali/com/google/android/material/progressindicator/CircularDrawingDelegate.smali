...
.method private calculateDisplayedPath(Landroid/graphics/PathMeasure;Landroid/graphics/Path;Landroid/util/Pair;FFFF)V
    ...
    iget-object v5, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->spec:Lcom/google/android/material/progressindicator/BaseProgressIndicatorSpec;

    check-cast v5, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;

    iget v5, v5, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;->wavelengthDeterminate:I
    ...
    iget v5, v5, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;->wavelengthIndeterminate:I
    ...
    iget-object v6, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->activePathMeasure:Landroid/graphics/PathMeasure;
    ...
    iget v6, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->cachedWavelength:I
    ...
    .line 533
    iput v5, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->cachedWavelength:I
    ...
    .line 540
    .local v8, "resultRotation":F
    iget-object v9, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->spec:Lcom/google/android/material/progressindicator/BaseProgressIndicatorSpec;

    check-cast v9, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;

    iget-boolean v10, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->drawingDeterminateIndicator:Z

    invoke-virtual {v9, v10}, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;->hasWavyEffect(Z)Z
    ...
    .line 542
    .local v9, "cycleCount":F
    div-float v10, p7, v9

    .line 543
    .local v10, "phaseFractionInOneCycle":F
    ...
    .line 540
    .end local v9    # "cycleCount":F
    .end local v10    # "phaseFractionInOneCycle":F
    ...
    .line 549
    .local v10, "endDistance":F
    const/4 v9, 0x1

    invoke-virtual {v1, v7, v10, v2, v9}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z
    ...
    .line 552
    .local v9, "startPoint":Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;, "Lcom/google/android/material/progressindicator/DrawingDelegate<Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;>.PathPoint;"
    invoke-virtual {v9}, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->reset()V

    .line 553
    iget-object v12, v9, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->posVec:[F

    iget-object v13, v9, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->tanVec:[F

    invoke-virtual {v1, v7, v12, v13}, Landroid/graphics/PathMeasure;->getPosTan(F[F[F)Z

    .line 554
    iget-object v12, v3, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast v12, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;

    .line 555
    .local v12, "endPoint":Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;, "Lcom/google/android/material/progressindicator/DrawingDelegate<Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;>.PathPoint;"
    invoke-virtual {v12}, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->reset()V

    .line 556
    iget-object v13, v12, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->posVec:[F

    iget-object v14, v12, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->tanVec:[F

    invoke-virtual {v1, v10, v13, v14}, Landroid/graphics/PathMeasure;->getPosTan(F[F[F)Z

    .line 558
    iget-object v13, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->transform:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v13, v8}, Landroid/graphics/Matrix;->setRotate(F)V

    .line 560
    invoke-virtual {v9, v8}, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->rotate(F)V

    .line 561
    invoke-virtual {v12, v8}, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->rotate(F)V

    .line 562
    iget-object v13, v0, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->transform:Landroid/graphics/Matrix;

    invoke-virtual {v2, v13}, Landroid/graphics/Path;->transform(Landroid/graphics/Matrix;)V
...
.method private drawArc(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIIIFFZ)V
    ...
    :goto_1
    iget v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->totalTrackLengthFraction:F
    ...
    .line 280
    :cond_2
    iget v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedCornerRadius:F

    iget v2, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->adjustedRadius:F
    ...
    .line 290
    .local v2, "increasedArcFraction":F
    ...
    .line 298
    .end local v2    # "increasedArcFraction":F
    :cond_3
    iget v2, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->totalTrackLengthFraction:F

    sub-float v2, v0, v2

    invoke-static {v2, v0, v14}, Lcom/google/android/material/math/MathUtils;->lerp(FFF)F

    move-result v14

    .line 299
    iget v0, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->totalTrackLengthFraction:F

    invoke-static {v8, v0, v13}, Lcom/google/android/material/math/MathUtils;->lerp(FFF)F
    ...
    .line 302
    .local v7, "startGapSizeInDegrees":F
    move/from16 v6, p7
    ...
    .line 303
    .local v5, "endGapSizeInDegrees":F
    ...
    .line 311
    :cond_4
    iget-object v2, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->spec:Lcom/google/android/material/progressindicator/BaseProgressIndicatorSpec;

    check-cast v2, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;

    iget-boolean v3, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->drawingDeterminateIndicator:Z
    ...
    .line 319
    iget v2, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedTrackThickness:F

    invoke-virtual {v12, v2}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    .line 324
    iget v2, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedCornerRadius:F

    mul-float v19, v2, v1

    .line 325
    .local v19, "blockWidth":F
    mul-float v2, v9, v1
    ...
    .line 329
    .local v20, "centerDegree":F
    new-instance v2, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;

    invoke-direct {v2, v11}, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;-><init>(Lcom/google/android/material/progressindicator/DrawingDelegate;)V

    .line 330
    .local v2, "center":Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;, "Lcom/google/android/material/progressindicator/DrawingDelegate<Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;>.PathPoint;"
    if-nez v18, :cond_6

    .line 331
    add-float v3, v20, v3

    invoke-virtual {v2, v3}, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->rotate(F)V

    .line 332
    iget v0, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->adjustedRadius:F

    neg-float v0, v0

    invoke-virtual {v2, v0}, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->moveAcross(F)V
    ...
    iget-object v3, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->activePathMeasure:Landroid/graphics/PathMeasure;
    ...
    iget v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedAmplitude:F

    mul-float v1, v1, p8

    .line 336
    .local v1, "amplitude":F
    iget v3, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->adjustedRadius:F

    iget v4, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->cachedRadius:F

    cmpl-float v3, v3, v4

    if-nez v3, :cond_7

    iget v3, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->cachedAmplitude:F
    ...
    .line 337
    :cond_7
    iput v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->cachedAmplitude:F

    .line 338
    iget v3, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->adjustedRadius:F

    iput v3, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->cachedRadius:F

    .line 339
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->invalidateCachedPaths()V
    ...
    .end local v1    # "amplitude":F
    .local p3, "amplitude":F
    iget-object v1, v2, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->tanVec:[F

    invoke-virtual {v3, v0, v4, v1}, Landroid/graphics/PathMeasure;->getPosTan(F[F[F)Z

    .line 343
    .end local v0    # "centerDistance":F
    ...
    .line 344
    iget v4, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedTrackThickness:F
    ...
    .end local v2    # "center":Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;, "Lcom/google/android/material/progressindicator/DrawingDelegate<Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;>.PathPoint;"
    .local v21, "center":Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;, "Lcom/google/android/material/progressindicator/DrawingDelegate<Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;>.PathPoint;"
    move-object/from16 v2, p2
    ...
    .end local v5    # "endGapSizeInDegrees":F
    ...
    .end local v20    # "centerDegree":F
    .end local v21    # "center":Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;, "Lcom/google/android/material/progressindicator/DrawingDelegate<Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;>.PathPoint;"
    ...
    .line 347
    .end local v23    # "endGapSizeInDegrees":F
    .restart local v5    # "endGapSizeInDegrees":F
    :cond_9
    move/from16 v23, v5

    .end local v5    # "endGapSizeInDegrees":F
    .restart local v23    # "endGapSizeInDegrees":F
    ...
    invoke-virtual {v2}, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;->useStrokeCap()Z
    ...
    sub-float v21, v16, v1

    .line 352
    .local v21, "arcDegreeWithoutCorners":F
    iget-object v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->endPoints:Landroid/util/Pair;
    ...
    .line 355
    iget-object v0, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->endPoints:Landroid/util/Pair;
    ...
    iget v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->adjustedRadius:F
    ...
    .line 359
    iget-object v0, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->arcBounds:Landroid/graphics/RectF;
    ...
    iget v4, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->adjustedRadius:F

    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/graphics/RectF;->set(FFFF)V

    .line 360
    iget-object v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->arcBounds:Landroid/graphics/RectF;
    ...
    .line 362
    :cond_b
    iget-object v1, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->activePathMeasure:Landroid/graphics/PathMeasure;

    iget-object v2, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedActivePath:Landroid/graphics/Path;

    iget-object v3, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->endPoints:Landroid/util/Pair;
    ...
    .end local v7    # "startGapSizeInDegrees":F
    .local v22, "startGapSizeInDegrees":F
    move/from16 v7, p9
    ...
    .line 370
    iget-object v0, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedActivePath:Landroid/graphics/Path;

    move-object/from16 v6, p1

    invoke-virtual {v6, v0, v12}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    .line 374
    :goto_5
    iget-object v0, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->spec:Lcom/google/android/material/progressindicator/BaseProgressIndicatorSpec;
    ...
    iget v0, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedCornerRadius:F
    ...
    iget v5, v11, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->displayedTrackThickness:F
    ...
    .end local v21    # "arcDegreeWithoutCorners":F
    :cond_c
    :goto_6
    return-void
.end method
...
.method private drawRoundedBlock(Landroid/graphics/Canvas;Landroid/graphics/Paint;Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;FFF)V
    ...
    .line 417
    iget-object v2, p3, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->posVec:[F
    ...
    .line 418
    iget-object v2, p3, Lcom/google/android/material/progressindicator/DrawingDelegate$PathPoint;->tanVec:[F

    invoke-virtual {p0, v2}, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->vectorToCanvasRotation([F)F
...
.method fillIndicator(Landroid/graphics/Canvas;Landroid/graphics/Paint;Lcom/google/android/material/progressindicator/DrawingDelegate$ActiveIndicator;I)V
    ...
    .line 178
    iget v3, v0, Lcom/google/android/material/progressindicator/DrawingDelegate$ActiveIndicator;->rotationDegree:F
    ...
    iput-boolean v3, v15, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->drawingDeterminateIndicator:Z
...
.method fillTrack(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    iput-boolean v0, v12, Lcom/google/android/material/progressindicator/CircularDrawingDelegate;->drawingDeterminateIndicator:Z
