...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, v6}, Lcom/google/android/material/search/SearchBar$1;-><init>(Lcom/google/android/material/search/SearchBar;)V

    iput-object v0, v6, Lcom/google/android/material/search/SearchBar;->liftColorListener:Lcom/google/android/material/appbar/AppBarLayout$LiftOnScrollProgressListener;
    ...
    iput v0, v6, Lcom/google/android/material/search/SearchBar;->backgroundColor:I

    .line 201
    sget v0, Lcom/google/android/material/R$styleable;->SearchBar_liftOnScrollColor:I

    .line 202
    invoke-static {v10, v12, v0}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v6, Lcom/google/android/material/search/SearchBar;->liftOnScrollColor:Landroid/content/res/ColorStateList;
    ...
    .line 207
    .local v15, "hideNavigationIcon":Z
    ...
    sget v0, Lcom/google/android/material/R$styleable;->SearchBar_textCentered:I

    invoke-virtual {v12, v0, v11}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    iput-boolean v0, v6, Lcom/google/android/material/search/SearchBar;->textCentered:Z

    .line 219
    sget v0, Lcom/google/android/material/R$styleable;->SearchBar_liftOnScroll:I

    invoke-virtual {v12, v0, v11}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    iput-boolean v0, v6, Lcom/google/android/material/search/SearchBar;->liftOnScroll:Z

    .line 220
    sget v0, Lcom/google/android/material/R$styleable;->SearchBar_android_maxWidth:I

    invoke-virtual {v12, v0, v9}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v0

    iput v0, v6, Lcom/google/android/material/search/SearchBar;->maxWidth:I
    ...
    .line 234
    sget v0, Lcom/google/android/material/R$id;->open_search_bar_placeholder_text_view:I
    ...
    iput-object v0, v6, Lcom/google/android/material/search/SearchBar;->placeholderTextView:Landroid/widget/TextView;

    .line 235
    sget v0, Lcom/google/android/material/R$id;->open_search_bar_text_view_container:I
    ...
    iput-object v0, v6, Lcom/google/android/material/search/SearchBar;->textViewContainer:Landroid/widget/FrameLayout;

    .line 237
    invoke-virtual {v6, v14}, Lcom/google/android/material/search/SearchBar;->setElevation(F)V

    .line 238
    invoke-direct {v6, v5, v4, v3}, Lcom/google/android/material/search/SearchBar;->initTextView(ILjava/lang/String;Ljava/lang/String;)V

    .line 239
    iget v2, v6, Lcom/google/android/material/search/SearchBar;->backgroundColor:I
    ...
    .end local v5    # "textAppearanceResId":I
    .local v18, "textAppearanceResId":I
    move/from16 v5, v17
...
.method private layoutTextViewCenterAvoidToolbarViewsAndPadding()V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->getMeasuredWidth()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->getMeasuredHeight()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->getLayoutDirection()I
    ...
    .line 602
    .local v5, "isRtl":Z
    invoke-direct/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->findOrGetMenuView()Landroidx/appcompat/widget/ActionMenuView;

    move-result-object v7

    .line 603
    .local v7, "menuView":Landroid/view/View;
    invoke-direct/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->findOrGetNavView()Landroid/widget/ImageButton;
    ...
    .line 629
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->getPaddingLeft()I

    move-result v5

    sub-int/2addr v5, v11

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->getContentInsetLeft()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->getPaddingRight()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/search/SearchBar;->getContentInsetRight()I
    ...
    .local v20, "menuView":Landroid/view/View;
    sub-int v7, v12, v17
    ...
    .line 641
    .local v7, "totalShift":I
    move/from16 v17, v5

    .end local v5    # "paddingLeftShift":I
    .local v17, "paddingLeftShift":I
    iget-object v5, v0, Lcom/google/android/material/search/SearchBar;->textViewContainer:Landroid/widget/FrameLayout;
    ...
    .local v19, "textViewContainerLeft":I
    add-int v1, v2, v7

    invoke-virtual {v5, v0, v3, v1, v4}, Landroid/widget/FrameLayout;->layout(IIII)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-direct {p0, v0}, Lcom/google/android/material/search/SearchBar;->layoutViewInCenter(Landroid/view/View;)V
