...
.method static fromXyzInViewingConditions(DDDLcom/google/android/material/color/utilities/ViewingConditions;)Lcom/google/android/material/color/utilities/Cam16;
    ...
    cmpg-double v45, v39, v41

    if-gez v45, :cond_0

    .line 256
    add-double v41, v39, v43

    goto :goto_0

    .line 257
    :cond_0
    cmpl-double v41, v39, v43

    if-ltz v41, :cond_1

    sub-double v41, v39, v43
    ...
    div-double v6, v45, v6

    div-double v47, v4, v17
    ...
    .line 277
    .local v6, "q":D
    const-wide v47, 0x403423d70a3d70a4L    # 20.14

    cmpg-double v49, v41, v47
    ...
    .line 278
    .local v43, "huePrime":D
    :goto_1
    invoke-static/range {v43 .. v44}, Ljava/lang/Math;->toRadians(D)D

    move-result-wide v47

    add-double v47, v47, v25
    ...
    add-double v25, v25, v47

    const-wide/high16 v47, 0x3fd0000000000000L    # 0.25

    mul-double v25, v25, v47

    .line 279
    .local v25, "eHue":D
    const-wide v47, 0x40ae0c4ec4ec4ec5L    # 3846.153846153846
    ...
    mul-double v47, v47, v72

    const-wide v49, 0x3fd3851eb851eb85L    # 0.305
    ...
    const-wide/high16 v50, 0x4049000000000000L    # 50.0

    mul-double v80, v45, v50

    .local v80, "s":D
    move-wide/from16 v56, v80

    .line 290
    const-wide v45, 0x3ffb333333333334L    # 1.7000000000000002

    mul-double v45, v45, v4

    const-wide v50, 0x3f7cac083126e979L    # 0.007
    ...
    div-double v82, v45, v50

    .local v82, "jstar":D
    move-wide/from16 v58, v82

    .line 291
    const-wide v45, 0x3f9758e219652bd4L    # 0.0228

    mul-double v45, v45, v17

    invoke-static/range {v45 .. v46}, Ljava/lang/Math;->log1p(D)D

    move-result-wide v45

    const-wide v50, 0x4045ee08fb823ee0L    # 43.859649122807014

    mul-double v84, v45, v50
    ...
    mul-double v86, v84, v45

    .local v86, "astar":D
    move-wide/from16 v60, v86

    .line 293
    invoke-static/range {v64 .. v65}, Ljava/lang/Math;->sin(D)D

    move-result-wide v45

    mul-double v88, v84, v45

    .local v88, "bstar":D
    move-wide/from16 v62, v88

    .line 295
    new-instance v90, Lcom/google/android/material/color/utilities/Cam16;
    ...
    invoke-direct/range {v45 .. v63}, Lcom/google/android/material/color/utilities/Cam16;-><init>(DDDDDDDDD)V
