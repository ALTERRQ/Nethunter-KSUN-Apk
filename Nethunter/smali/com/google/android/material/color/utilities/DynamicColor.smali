...
.method public getTone(Lcom/google/android/material/color/utilities/DynamicScheme;)D
    ...
    .line 292
    .local v5, "polarity":Lcom/google/android/material/color/utilities/TonePolarity;
    ...
    .line 295
    .local v4, "bg":Lcom/google/android/material/color/utilities/DynamicColor;
    ...
    .line 302
    .local v7, "nearer":Lcom/google/android/material/color/utilities/DynamicColor;
    :goto_3
    if-eqz v6, :cond_5
    ...
    iget-object v9, v7, Lcom/google/android/material/color/utilities/DynamicColor;->name:Ljava/lang/String;
    ...
    :goto_5
    iget-object v9, v7, Lcom/google/android/material/color/utilities/DynamicColor;->contrastCurve:Lcom/google/android/material/color/utilities/ContrastCurve;
    ...
    .local v29, "toneDeltaPair":Lcom/google/android/material/color/utilities/ToneDeltaPair;
    ...
    .end local v4    # "bg":Lcom/google/android/material/color/utilities/DynamicColor;
    .end local v5    # "polarity":Lcom/google/android/material/color/utilities/TonePolarity;
    .local v30, "polarity":Lcom/google/android/material/color/utilities/TonePolarity;
    .local v31, "bg":Lcom/google/android/material/color/utilities/DynamicColor;
    iget-wide v4, v1, Lcom/google/android/material/color/utilities/DynamicScheme;->contrastLevel:D

    invoke-virtual {v3, v4, v5}, Lcom/google/android/material/color/utilities/ContrastCurve;->get(D)D

    move-result-wide v3

    .line 312
    .local v3, "fContrast":D
    iget-object v5, v7, Lcom/google/android/material/color/utilities/DynamicColor;->tone:Ljava/util/function/Function;
    ...
    .line 322
    .local v5, "fInitialTone":D
    invoke-static {v12, v13, v5, v6}, Lcom/google/android/material/color/utilities/Contrast;->ratioOfTones(DD)D

    move-result-wide v36

    cmpl-double v20, v36, v3
    ...
    .line 324
    :cond_8
    invoke-static {v12, v13, v3, v4}, Lcom/google/android/material/color/utilities/DynamicColor;->foregroundTone(DD)D
    ...
    .restart local v5    # "fInitialTone":D
    :cond_c
    move-wide/from16 v38, v5
    ...
    cmpg-double v20, v5, v3

    if-gtz v20, :cond_11

    const-wide/high16 v5, 0x404e000000000000L    # 60.0

    cmpg-double v20, v3, v5
    ...
    .end local v7    # "nearer":Lcom/google/android/material/color/utilities/DynamicColor;
    ...
    .end local v29    # "toneDeltaPair":Lcom/google/android/material/color/utilities/ToneDeltaPair;
    .end local v30    # "polarity":Lcom/google/android/material/color/utilities/TonePolarity;
    .end local v31    # "bg":Lcom/google/android/material/color/utilities/DynamicColor;
    .end local v32    # "nTone":D
    .end local v34    # "nInitialTone":D
    .end local v36    # "fContrast":D
    .end local v38    # "fInitialTone":D
    :cond_13
    move-wide v5, v6
