...
.method private broadcastCompatCheck(Z)V
    .locals 3
    .param p1, "enableFragment"    # Z
    ...
    .line 92
    const-string v2, "ENABLEFRAGMENT"
    ...
    .line 93
    const-string v2, "com.offsec.nethunter.CHECKCHROOT"
    ...
    .line 94
    invoke-virtual {p0}, Lcom/offsec/nethunter/service/CompatCheckService;->getPackageName()Ljava/lang/String;
...
.method private checkCompat()Z
    ...
    .line 68
    .local v0, "chrootDirs":[Ljava/lang/String;
    array-length v3, v0
    ...
    sget-object v4, Lcom/offsec/nethunter/utils/NhPaths;->CHROOT_SYMLINK_PATH:Ljava/lang/String;
    ...
    .line 79
    .end local v0    # "chrootDirs":[Ljava/lang/String;
    :cond_2
    :goto_0
    ...
    const-string v4, "/chrootmgr -c \"status\" -p "
    ...
    .line 82
    .local v0, "isChrootValid":Z
    invoke-direct {p0, v0}, Lcom/offsec/nethunter/service/CompatCheckService;->broadcastCompatCheck(Z)V

    .line 83
    .end local v0    # "isChrootValid":Z
    goto :goto_1
    ...
    :cond_5
    invoke-direct {p0, v1}, Lcom/offsec/nethunter/service/CompatCheckService;->broadcastCompatCheck(Z)V
